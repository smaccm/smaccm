...
public class Connection {
	...
	private ConnectionInstance aadlInstance; 

	// MWW: I do not think that these will be necessary for the AST
	//private ConnectionInstanceEnd source;
	//private ConnectionInstanceEnd destination;
	// MWW: end unnecessary stuff...
	...
	public ConnectionInstance getAadlInstance() {
