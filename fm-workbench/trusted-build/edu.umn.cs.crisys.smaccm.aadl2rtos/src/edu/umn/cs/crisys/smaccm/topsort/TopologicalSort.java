...
public class TopologicalSort {
	...
	public static<T2 extends DependsOn<T2>> void 
		topoSortElement(T2 elem, Map<T2, Color> assoc, List<T2> sorted) throws CyclicException {
	...
	public static<T2 extends DependsOn<T2>> List<T2> performTopologicalSort(Collection<T2> elements) throws CyclicException {
