...
public abstract class PropertyUtil {
	...
	final public static String TB_SYS_SIGNAL_NAME_NAME = "TB_SYS::Signal_Name";
  final public static String TB_SYS_SIGNAL_NUMBER_NAME = "TB_SYS::Signal_Number";
	final public static String TB_SYS_IS_ISR_NAME = "TB_SYS::Is_ISR";
  final public static String TB_SYS_MEMORY_PAGES_NAME = "TB_SYS::Memory_Pages";
  final public static String TB_SYS_OS_NAME = "TB_SYS::OS";
  final public static String TB_SYS_HW_NAME = "TB_SYS::HW";
  final public static String TB_SYS_OUTPUT_DIRECTORY_NAME = "TB_SYS::Output_Directory";
  
	final public static String TB_SYS_COMMPRIM_SOURCE_HEADER_NAME = "TB_SYS::CommPrim_Source_Header";
  final public static String TB_SYS_COMMPRIM_SOURCE_TEXT_NAME = "TB_SYS::CommPrim_Source_Text";
  final public static String TB_SYS_COMPUTE_ENTRYPOINT_SOURCE_TEXT_NAME = "TB_SYS::Compute_Entrypoint_Source_Text";
  final public static String PERIOD_NAME = "Period";
	final public static String PRIORITY_NAME = "Priority";
	final public static String LEGACY_NAME = "TB_SYS::Is_External";
	final public static String LEGACY_MUTEX_LIST_NAME = "TB_SYS::External_Mutex_List";
  final public static String LEGACY_SEMAPHORE_LIST_NAME = "TB_SYS::External_Semaphore_List";
	final public static String LEGACY_ENTRYPOINT_NAME = "TB_SYS::External_Entrypoint";
  final public static String LEGACY_EXTERNAL_IRQ_LIST_NAME = "TB_SYS::External_IRQ_Handler_List";
  final public static String LEGACY_EXTERNAL_IRQ_EVENT_LIST_NAME = "TB_SYS::External_IRQ_Event_List";
  final public static String EXTERNAL_IRQ_LIST_NAME = "TB_SYS::External_IRQ_List";
  final public static String GENERATE_SCHEDULER_SYSTICK_IRQ_NAME = "TB_SYS::Generate_Scheduler_Systick_IRQ";
  final public static String ISR_HANDLER_NAME = "TB_SYS::First_Level_Interrupt_Handler";
  final public static String THREAD_TYPE_NAME = "TB_SYS::Thread_Type";
  final public static String TB_SYS_SENDS_EVENTS_TO_NAME = "TB_SYS::Sends_Events_To";
  final public static String CAMKES_OWNER_THREAD_NAME = "TB_SYS::CAmkES_Owner_Thread";
  final public static String USE_OS_REAL_TIME_EXTENSIONS_NAME = "TB_SYS::Use_OS_Real_Time_Extensions";
  ...
  final public static String C_TYPE_NAME_NAME = "TB_SYS::C_Type_Name";
  final public static String PASS_BY_REFERENCE_NAME = "TB_SYS::By_Reference";
  final public static String EXTERNAL_TIMER_COMPONENT_NAME = "TB_SYS::External_Timer_Component";
  final public static String CAMKES_EXTERNAL_TIMER_INTERFACE_PATH_NAME = "TB_SYS::CAmkES_External_Timer_Interface_Path"; 
  final public static String CAMKES_EXTERNAL_TIMER_COMPLETE_PATH_NAME = "TB_SYS::CAmkES_External_Timer_Complete_Path";
  final public static String CAMKES_INTERNAL_TIMER_TIMERS_PER_CLIENT_NAME = "TB_SYS::CAmkES_Internal_Timer_Timers_Per_Client"; 
  final public static String CAMKES_TIME_SERVER_AADL_THREAD_MIN_INDEX_NAME = "TB_SYS::CAmkES_Time_Server_AADL_Thread_Min_Index"; 
  final public static String MAILBOX_NAME = "TB_SYS::Mailbox"; 
  final public static String REQUIRES_TIME_SERVICES_NAME = "TB_SYS::Requires_Time_Services";
  final public static String CAMKES_DATAPORT_RPC_MIN_INDEX_NAME = "TB_SYS::CAmkES_Dataport_RPC_Min_Index";
  final public static String ECHRONOS_GENERATE_C_MODULES_NAME = "TB_SYS::eChronos_Generate_C_Modules";
  final public static String ECHRONOS_C_MODULE_PATH_NAME = "TB_SYS::eChronos_C_Module_Path";
  final public static String ECHRONOS_FLASH_LOAD_ADDRESS_NAME = "TB_SYS::eChronos_Flash_Load_Address";
	...
	final public static Property TB_SYS_IS_ISR = Util
	    .getPropertyDefinitionInWorkspace(TB_SYS_IS_ISR_NAME);
  final public static Property TB_SYS_MEMORY_PAGES = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_MEMORY_PAGES_NAME);
	final public static Property TB_SYS_SIGNAL_NAME = Util
			.getPropertyDefinitionInWorkspace(TB_SYS_SIGNAL_NAME_NAME);
  final public static Property TB_SYS_SIGNAL_NUMBER = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_SIGNAL_NUMBER_NAME);
	...
	final public static Property TB_SYS_COMMPRIM_SOURCE_TEXT = Util
	    .getPropertyDefinitionInWorkspace(TB_SYS_COMMPRIM_SOURCE_TEXT_NAME);
  final public static Property TB_SYS_OS = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_OS_NAME);
  final public static Property TB_SYS_HW = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_HW_NAME);
  final public static Property TB_SYS_OUTPUT_DIRECTORY = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_OUTPUT_DIRECTORY_NAME);
  ...
  final public static Property THREAD_TYPE = Util.getPropertyDefinitionInWorkspace(THREAD_TYPE_NAME);
	final public static Property TB_SYS_COMPUTE_ENTRYPOINT_SOURCE_TEXT =
	    Util.getPropertyDefinitionInWorkspace(TB_SYS_COMPUTE_ENTRYPOINT_SOURCE_TEXT_NAME);
  final public static Property TB_SYS_SENDS_EVENTS_TO = Util
      .getPropertyDefinitionInWorkspace(TB_SYS_SENDS_EVENTS_TO_NAME);
