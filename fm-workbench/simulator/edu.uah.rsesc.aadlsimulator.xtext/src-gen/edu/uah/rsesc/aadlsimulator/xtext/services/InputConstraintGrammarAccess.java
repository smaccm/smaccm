...
public class InputConstraintGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class InputConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "InputConstraint");
	...
	public class ScalarElements extends AbstractParserRuleElementFinder {
		...
		//Scalar returns ScalarExpression:
		//	AddSub;
		@Override public ParserRule getRule() { return rule; }
	...
	public class AddSubElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AddSub");
	...
	public class MultDivElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MultDiv");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FunctionElements extends AbstractParserRuleElementFinder {
		...
		//Function returns ScalarExpression:
	...
	public class RandomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Random");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class RandomIntegerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RandomInteger");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//RandomInteger returns RandomExpression:
	...
	public class RandomRealElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RandomReal");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//RandomReal returns RandomExpression:
	...
	public class RandomElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RandomElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//RandomElement returns RandomExpression:
	...
	public class ElementRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ElementRef");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//ElementRef returns RefExpression:
	...
	public class ConstRefElements extends AbstractParserRuleElementFinder {
		...
		//ConstRef returns RefExpression:
	...
	public class NegativeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Negative");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMembersScalarParserRuleCall_2_0 = (RuleCall)cMembersAssignment_2.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cCommaKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cMembersAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cMembersScalarParserRuleCall_3_1_0 = (RuleCall)cMembersAssignment_3_1.eContents().get(0);
		...
		//Scalar
		public RuleCall getMembersScalarParserRuleCall_2_0() { return cMembersScalarParserRuleCall_2_0; }
		...
		//Scalar
		public RuleCall getMembersScalarParserRuleCall_3_1_0() { return cMembersScalarParserRuleCall_3_1_0; }
	...
	public class BIG_INTElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "BIG_INT");
	...
	public class AddSubOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "AddSubOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MultDivOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "MultDivOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final AddSubOperatorElements unknownRuleAddSubOperator;
	private final MultDivOperatorElements unknownRuleMultDivOperator;
	...
	public InputConstraintGrammarAccess(GrammarProvider grammarProvider,
		...
		this.unknownRuleAddSubOperator = new AddSubOperatorElements();
		this.unknownRuleMultDivOperator = new MultDivOperatorElements();
		...
		this.tBIGDECIMAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "BIGDECIMAL");
	...
	public AddSubOperatorElements getAddSubOperatorAccess() {
		return unknownRuleAddSubOperator;
	}
	...
	public MultDivOperatorElements getMultDivOperatorAccess() {
		return unknownRuleMultDivOperator;
	}
