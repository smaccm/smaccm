...
demonstrated in @sec:agree_to_simulink_exporter.
...
![General Simulink Models Dialog](../../media/image29.png){#fig:general_simulink_models_dialog width="6.491666666666666in" height="3.05in"}
