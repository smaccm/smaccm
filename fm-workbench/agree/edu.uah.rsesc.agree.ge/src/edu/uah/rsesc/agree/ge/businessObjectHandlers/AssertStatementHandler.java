...
public class AssertStatementHandler {
	...
	@IsApplicable
	@CanDelete
	public boolean isApplicable(final @Named(Names.BUSINESS_OBJECT) AssertStatement bo) {
		return true;
	}
	...
	public GraphicalConfiguration getGraphicalConfiguration(
		...
		return GraphicalConfigurationBuilder.create().graphic(graphic).annotation("<assertion>")
				.style(StyleBuilder
	...
	public PaletteEntry[] getPaletteEntries(final @Named(Names.DIAGRAM_BO) Object diagramBo) {
		...
		return new PaletteEntry[] {
				PaletteEntryBuilder.create().label("Assertion").category(AgreeCategories.AGREE).build() };
	}
	...
	@GetName
	public String getName(final @Named(Names.BUSINESS_OBJECT) AssertStatement bo) {
		return AgreeHandlerUtil.toDisplayName(bo.getStr());
	}

	@GetNameForEditing
	public String getNameForEditing(final @Named(Names.BUSINESS_OBJECT) AssertStatement bo) {
		return bo.getStr();
	}

	@ValidateName
	public String validateName(final @Named(Names.BUSINESS_OBJECT) AssertStatement bo,
	...
	@Rename
	public void setName(final @Named(Names.BUSINESS_OBJECT) AssertStatement bo,
			final @Named(Names.NAME) String value) {
		bo.setStr(value);
	}
}
