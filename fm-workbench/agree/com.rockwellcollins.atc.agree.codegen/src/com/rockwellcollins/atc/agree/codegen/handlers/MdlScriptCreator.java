...
public class MdlScriptCreator extends ScriptCreator{
    ...
    public HashMap<String, SortedMap<String, MATLABType>> busdefs = new HashMap<String, SortedMap<String, MATLABType>>();
	
	public MdlScriptCreator (String outputDir, String implMdl, String verifMdlName, String subSysName, List<MATLABPort> ports, String scriptName, boolean createImplModel, boolean invokeSLDV) throws Exception {
