 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.LemmaStatement#getName <em>Name</em>}</li>
...
public interface LemmaStatement extends SpecStatement
{
   ...
   * @see #setName(String)
   * @see com.rockwellcollins.atc.agree.agree.AgreePackage#getLemmaStatement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.rockwellcollins.atc.agree.agree.LemmaStatement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
