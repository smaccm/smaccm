...
public class AgreeContractSubclauseImpl extends AgreeSubclauseImpl implements AgreeContractSubclause {
	...
	public void setContract(Contract newContract) {
		if (newContract != contract) {
			...
			if (contract != null) {
				msgs = ((InternalEObject) contract).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.AGREE_CONTRACT_SUBCLAUSE__CONTRACT, null, msgs);
			}
			if (newContract != null) {
				msgs = ((InternalEObject) newContract).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.AGREE_CONTRACT_SUBCLAUSE__CONTRACT, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.AGREE_CONTRACT_SUBCLAUSE__CONTRACT,
