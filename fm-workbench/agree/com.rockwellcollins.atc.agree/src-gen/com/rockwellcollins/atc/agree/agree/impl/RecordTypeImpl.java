	...
	public NotificationChain basicSetRecord(NestedDotID newRecord, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.RECORD_TYPE__RECORD, oldRecord, newRecord);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newRecord != record) {
			...
			if (record != null) {
				msgs = ((InternalEObject) record).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.RECORD_TYPE__RECORD, null, msgs);
			}
			if (newRecord != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.RECORD_TYPE__RECORD, newRecord,
					newRecord));
		}
	}
