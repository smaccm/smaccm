	...
	public NotificationChain basicSetPeriod(Expr newPeriod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.PERIODIC_STATEMENT__PERIOD, oldPeriod, newPeriod);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newPeriod != period) {
			...
			if (period != null) {
				msgs = ((InternalEObject) period).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.PERIODIC_STATEMENT__PERIOD, null, msgs);
			}
			if (newPeriod != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PERIODIC_STATEMENT__PERIOD, newPeriod,
					newPeriod));
		}
	}
