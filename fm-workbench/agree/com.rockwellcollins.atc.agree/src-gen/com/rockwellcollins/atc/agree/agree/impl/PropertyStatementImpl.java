 ...
 * <em><b>Property Statement</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.PropertyStatementImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PROPERTY_STATEMENT__EXPR, oldExpr, newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PROPERTY_STATEMENT__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PROPERTY_STATEMENT__EXPR, newExpr, newExpr));
        }
    }
