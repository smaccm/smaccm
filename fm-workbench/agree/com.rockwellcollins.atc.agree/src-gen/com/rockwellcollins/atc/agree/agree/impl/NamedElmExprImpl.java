 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.impl.NamedElmExprImpl#getNamedElm <em>Named Elm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedElmExprImpl extends ExprImpl implements NamedElmExpr
{
    ...
    if (namedElm != null && ((EObject)namedElm).eIsProxy())
    {
      ...
      if (namedElm != oldNamedElm)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.NAMED_ELM_EXPR__NAMED_ELM, oldNamedElm, namedElm));
      }
    }
    return namedElm;
  }
  ...
  public void setNamedElm(NamedElement newNamedElm)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.NAMED_ELM_EXPR__NAMED_ELM, oldNamedElm, namedElm));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AgreePackage.NAMED_ELM_EXPR__NAMED_ELM:
