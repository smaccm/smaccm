 ...
 * <em><b>Bool Lit Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.BoolLitExprImpl#getVal
 * <em>Val</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetVal(BooleanLiteral newVal, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.BOOL_LIT_EXPR__VAL, oldVal, newVal);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newVal != val) {
            ...
            if (val != null) {
                msgs = ((InternalEObject) val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.BOOL_LIT_EXPR__VAL, null, msgs);
            }
            if (newVal != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.BOOL_LIT_EXPR__VAL,
                    newVal, newVal));
        }
    }
