...
public class WheneverImpliesStatementImpl extends WheneverStatementImpl implements WheneverImpliesStatement {
	...
	public NotificationChain basicSetLhs(Expr newLhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHENEVER_IMPLIES_STATEMENT__LHS, oldLhs, newLhs);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newLhs != lhs) {
			...
			if (lhs != null) {
				msgs = ((InternalEObject) lhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_IMPLIES_STATEMENT__LHS, null, msgs);
			}
			if (newLhs != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_IMPLIES_STATEMENT__LHS, newLhs,
					newLhs));
		}
	}
	...
	public NotificationChain basicSetRhs(Expr newRhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHENEVER_IMPLIES_STATEMENT__RHS, oldRhs, newRhs);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newRhs != rhs) {
			...
			if (rhs != null) {
				msgs = ((InternalEObject) rhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_IMPLIES_STATEMENT__RHS, null, msgs);
			}
			if (newRhs != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_IMPLIES_STATEMENT__RHS, newRhs,
					newRhs));
		}
	}
