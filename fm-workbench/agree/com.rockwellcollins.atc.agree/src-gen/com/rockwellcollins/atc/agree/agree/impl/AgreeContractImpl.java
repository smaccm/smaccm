 ...
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.AgreeContractImpl#getSpecs
 * <em>Specs</em>}</li>
 * </ul>
 * </p>
 * 
...
public class AgreeContractImpl extends ContractImpl implements AgreeContract {
    /**
     * The cached value of the '{@link #getSpecs() <em>Specs</em>}' containment
    ...
    public EList<SpecStatement> getSpecs() {
        if (specs == null) {
            specs = new EObjectContainmentEList<SpecStatement>(SpecStatement.class, this,
                    AgreePackage.AGREE_CONTRACT__SPECS);
        }
        return specs;
    }
