...
public class WhenOccursStatmentImpl extends WhenStatementImpl implements WhenOccursStatment {
	...
	public NotificationChain basicSetTimes(Expr newTimes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_OCCURS_STATMENT__TIMES, oldTimes, newTimes);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTimes(Expr newTimes) {
		if (newTimes != times) {
			...
			if (times != null) {
				msgs = ((InternalEObject) times).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_OCCURS_STATMENT__TIMES, null, msgs);
			}
			if (newTimes != null) {
				msgs = ((InternalEObject) newTimes).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_OCCURS_STATMENT__TIMES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_OCCURS_STATMENT__TIMES, newTimes,
					newTimes));
		}
	}
	...
	public NotificationChain basicSetInterval(TimeInterval newInterval, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_OCCURS_STATMENT__INTERVAL, oldInterval, newInterval);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newInterval != interval) {
			...
			if (interval != null) {
				msgs = ((InternalEObject) interval).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_OCCURS_STATMENT__INTERVAL, null, msgs);
			}
			if (newInterval != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_OCCURS_STATMENT__INTERVAL,
