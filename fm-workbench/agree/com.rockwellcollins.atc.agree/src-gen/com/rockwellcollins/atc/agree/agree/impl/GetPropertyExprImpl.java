...
public class GetPropertyExprImpl extends ExprImpl implements GetPropertyExpr {
		...
		if (newComponent != component) {
			...
			if (component != null) {
				msgs = ((InternalEObject) component).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.GET_PROPERTY_EXPR__COMPONENT, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.GET_PROPERTY_EXPR__COMPONENT,
	...
	public NamedElement getProp() {
		if (prop != null && ((EObject) prop).eIsProxy()) {
			...
			if (prop != oldProp) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.GET_PROPERTY_EXPR__PROP,
							oldProp, prop));
				}
			}
		}
