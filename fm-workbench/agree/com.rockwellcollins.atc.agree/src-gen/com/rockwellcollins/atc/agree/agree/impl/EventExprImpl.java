...
public class EventExprImpl extends ExprImpl implements EventExpr {
	...
	public NotificationChain basicSetId(NestedDotID newId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.EVENT_EXPR__ID,
					oldId, newId);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setId(NestedDotID newId) {
		if (newId != id) {
			...
			if (id != null) {
				msgs = ((InternalEObject) id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgreePackage.EVENT_EXPR__ID,
						null, msgs);
			}
			if (newId != null) {
				msgs = ((InternalEObject) newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgreePackage.EVENT_EXPR__ID,
						null, msgs);
			}
