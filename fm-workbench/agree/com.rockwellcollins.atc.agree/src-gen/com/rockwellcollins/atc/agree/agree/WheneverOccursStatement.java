 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.WheneverOccursStatement#getEffect <em>Effect</em>}</li>
 * </ul>
 *
...
public interface WheneverOccursStatement extends WheneverStatement
{
   ...
   * @see #setEffect(Expr)
   * @see com.rockwellcollins.atc.agree.agree.AgreePackage#getWheneverOccursStatement_Effect()
  ...
  /**
   * Sets the value of the '{@link com.rockwellcollins.atc.agree.agree.WheneverOccursStatement#getEffect <em>Effect</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
