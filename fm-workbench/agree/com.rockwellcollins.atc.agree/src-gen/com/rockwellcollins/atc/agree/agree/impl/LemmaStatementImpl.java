 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.impl.LemmaStatementImpl#getName <em>Name</em>}</li>
...
public class LemmaStatementImpl extends SpecStatementImpl implements LemmaStatement
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LEMMA_STATEMENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AgreePackage.LEMMA_STATEMENT__NAME:
        return getName();
