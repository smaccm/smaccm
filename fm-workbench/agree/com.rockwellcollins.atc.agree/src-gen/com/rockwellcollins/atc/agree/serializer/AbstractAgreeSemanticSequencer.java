...
public abstract class AbstractAgreeSemanticSequencer extends PropertiesSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == Aadl2Package.eINSTANCE)
			...
			case AgreePackage.BASE_ID:
				sequence_ChainID(context, (BaseID) semanticObject); 
				return; 
			...
			case AgreePackage.RECORD_PROJ:
				sequence_ChainID(context, (RecordProj) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     ChainID returns BaseID
	 *     ChainID.RecordProj_1_0_0 returns BaseID
	 *
	 * Constraint:
	 *     namedElm=[NamedElement|QCPREF]
	 */
	protected void sequence_ChainID(ISerializationContext context, BaseID semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AgreePackage.Literals.CHAIN_ID__NAMED_ELM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AgreePackage.Literals.CHAIN_ID__NAMED_ELM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getChainIDAccess().getNamedElmNamedElementQCPREFParserRuleCall_0_1_0_1(), semanticObject.eGet(AgreePackage.Literals.CHAIN_ID__NAMED_ELM, false));
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     ChainID returns RecordProj
	 *     ChainID.RecordProj_1_0_0 returns RecordProj
	 *
	 * Constraint:
	 *     (chainID=ChainID_RecordProj_1_0_0 namedElm=[NamedElement|QCPREF])
	 */
	protected void sequence_ChainID(ISerializationContext context, RecordProj semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AgreePackage.Literals.RECORD_PROJ__CHAIN_ID) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AgreePackage.Literals.RECORD_PROJ__CHAIN_ID));
			if (transientValues.isValueTransient(semanticObject, AgreePackage.Literals.CHAIN_ID__NAMED_ELM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AgreePackage.Literals.CHAIN_ID__NAMED_ELM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getChainIDAccess().getRecordProjChainIDAction_1_0_0(), semanticObject.getChainID());
		feeder.accept(grammarAccess.getChainIDAccess().getNamedElmNamedElementQCPREFParserRuleCall_1_0_2_0_1(), semanticObject.eGet(AgreePackage.Literals.CHAIN_ID__NAMED_ELM, false));
		feeder.finish();
	}
