...
public class WhenStatementImpl extends PatternStatementImpl implements WhenStatement {
	...
	public NotificationChain basicSetCondition(Expr newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_STATEMENT__CONDITION, oldCondition, newCondition);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newCondition != condition) {
			...
			if (condition != null) {
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_STATEMENT__CONDITION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_STATEMENT__CONDITION, newCondition,
					newCondition));
		}
	}
	...
	public NotificationChain basicSetEvent(Expr newEvent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_STATEMENT__EVENT, oldEvent, newEvent);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newEvent != event) {
			...
			if (event != null) {
				msgs = ((InternalEObject) event).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_STATEMENT__EVENT, null, msgs);
			}
			if (newEvent != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_STATEMENT__EVENT, newEvent,
					newEvent));
		}
	}
