...
public class WheneverStatementImpl extends PatternStatementImpl implements WheneverStatement {
	...
	public NotificationChain basicSetCause(Expr newCause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHENEVER_STATEMENT__CAUSE, oldCause, newCause);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setCause(Expr newCause) {
		if (newCause != cause) {
			...
			if (cause != null) {
				msgs = ((InternalEObject) cause).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_STATEMENT__CAUSE, null, msgs);
			}
			if (newCause != null) {
				msgs = ((InternalEObject) newCause).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_STATEMENT__CAUSE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_STATEMENT__CAUSE, newCause,
					newCause));
		}
	}
	...
	public void setExcl(String newExcl) {
		...
		excl = newExcl;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_STATEMENT__EXCL, oldExcl,
					excl));
		}
	}
	...
	public NotificationChain basicSetInterval(TimeInterval newInterval, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHENEVER_STATEMENT__INTERVAL, oldInterval, newInterval);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newInterval != interval) {
			...
			if (interval != null) {
				msgs = ((InternalEObject) interval).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_STATEMENT__INTERVAL, null, msgs);
			}
			if (newInterval != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_STATEMENT__INTERVAL,
