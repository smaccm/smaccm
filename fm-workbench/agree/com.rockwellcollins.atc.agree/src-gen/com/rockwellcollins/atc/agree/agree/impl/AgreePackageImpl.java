...
public class AgreePackageImpl extends EPackageImpl implements AgreePackage
{
   ...
   * @generated
   */
  private EClass abstractionRefEClass = null;
   ...
   * @generated
   */
  private EClass enumIDEClass = null;
   ...
   * @generated
   */
  private EClass subcomponentRefEClass = null;
   ...
   * @generated
   */
  public EClass getAbstractionRef()
  {
    return abstractionRefEClass;
  }
   ...
   * @generated
   */
  public EClass getSubcomponentRef()
  {
    return subcomponentRefEClass;
  }
   ...
   * @generated
   */
  public EReference getSubcomponentRef_NamedElm()
  {
    return (EReference)subcomponentRefEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getCallExpr_AbstractionRef()
  {
  ...
  public void createPackageContents()
  {
    ...
    subcomponentRefEClass = createEClass(SUBCOMPONENT_REF);
    createEReference(subcomponentRefEClass, SUBCOMPONENT_REF__NAMED_ELM);
  ...
  public void initializePackageContents()
  {
    ...
    enumIDEClass.getESuperTypes().add(theAadl2Package.getNamedElement());
    ...
    subcomponentRefEClass.getESuperTypes().add(this.getComponentRef());
    ...
    initEReference(getEnumStatement_Enums(), this.getEnumID(), null, "enums", null, 0, -1, EnumStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(subcomponentRefEClass, SubcomponentRef.class, "SubcomponentRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSubcomponentRef_NamedElm(), theAadl2Package.getNamedElement(), null, "namedElm", null, 0, 1, SubcomponentRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRecordLitExpr_RecordType(), this.getCustomType(), null, "recordType", null, 0, 1, RecordLitExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEnumLitExpr_EnumType(), this.getCustomType(), null, "enumType", null, 0, 1, EnumLitExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
