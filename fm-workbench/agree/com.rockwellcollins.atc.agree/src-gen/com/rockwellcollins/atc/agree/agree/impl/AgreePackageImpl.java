...
public class AgreePackageImpl extends EPackageImpl implements AgreePackage
{
   ...
   * @generated
   */
  private EClass chainIDEClass = null;
   ...
   * @generated
   */
  private EClass baseIDEClass = null;
   ...
   * @generated
   */
  private EClass recordProjEClass = null;
   ...
   * @generated
   */
  public EReference getNestedDotID_ChainID()
  {
   ...
   * @generated
   */
  public EClass getChainID()
  {
    return chainIDEClass;
  }
   ...
   * @generated
   */
  public EReference getChainID_NamedElm()
  {
    return (EReference)chainIDEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getRecordProj()
  {
    return recordProjEClass;
  }
   ...
   * @generated
   */
  public EReference getRecordProj_ChainID()
  {
    return (EReference)recordProjEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(nestedDotIDEClass, NESTED_DOT_ID__CHAIN_ID);
    createEAttribute(nestedDotIDEClass, NESTED_DOT_ID__TAG);

    chainIDEClass = createEClass(CHAIN_ID);
    createEReference(chainIDEClass, CHAIN_ID__NAMED_ELM);
    ...
    baseIDEClass = createEClass(BASE_ID);

    recordProjEClass = createEClass(RECORD_PROJ);
    createEReference(recordProjEClass, RECORD_PROJ__CHAIN_ID);
  }
  ...
  public void initializePackageContents()
  {
    ...
    baseIDEClass.getESuperTypes().add(this.getChainID());
    recordProjEClass.getESuperTypes().add(this.getChainID());
    ...
    initEReference(getNestedDotID_ChainID(), this.getChainID(), null, "chainID", null, 0, 1, NestedDotID.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(chainIDEClass, ChainID.class, "ChainID", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getChainID_NamedElm(), theAadl2Package.getNamedElement(), null, "namedElm", null, 0, 1, ChainID.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(baseIDEClass, BaseID.class, "BaseID", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(recordProjEClass, RecordProj.class, "RecordProj", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRecordProj_ChainID(), this.getChainID(), null, "chainID", null, 0, 1, RecordProj.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
