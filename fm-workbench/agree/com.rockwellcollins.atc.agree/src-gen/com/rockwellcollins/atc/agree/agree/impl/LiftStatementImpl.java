...
public class LiftStatementImpl extends SpecStatementImpl implements LiftStatement {
	...
	public NotificationChain basicSetSubcomp(NestedDotID newSubcomp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LIFT_STATEMENT__SUBCOMP, oldSubcomp, newSubcomp);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setSubcomp(NestedDotID newSubcomp) {
		if (newSubcomp != subcomp) {
			...
			if (subcomp != null) {
				msgs = ((InternalEObject) subcomp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LIFT_STATEMENT__SUBCOMP, null, msgs);
			}
			if (newSubcomp != null) {
				msgs = ((InternalEObject) newSubcomp).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LIFT_STATEMENT__SUBCOMP, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LIFT_STATEMENT__SUBCOMP, newSubcomp,
					newSubcomp));
		}
	}
