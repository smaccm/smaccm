 ...
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.EqStatementImpl#getArgs
 * <em>Args</em>}</li>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.EqStatementImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class EqStatementImpl extends NamedElementImpl implements EqStatement {
    /**
    ...
    public EList<Arg> getArgs() {
        if (args == null) {
            args = new EObjectContainmentEList<Arg>(Arg.class, this,
                    AgreePackage.EQ_STATEMENT__ARGS);
        }
        return args;
    }
    ...
    public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.EQ_STATEMENT__EXPR, oldExpr, newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.EQ_STATEMENT__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.EQ_STATEMENT__EXPR,
                    newExpr, newExpr));
        }
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
        ...
        switch (featureID) {
        case AgreePackage.EQ_STATEMENT__ARGS:
