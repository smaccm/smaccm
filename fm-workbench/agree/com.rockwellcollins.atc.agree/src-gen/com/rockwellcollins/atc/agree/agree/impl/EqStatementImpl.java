 ...
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.impl.EqStatementImpl#getArgs <em>Args</em>}</li>
...
public class EqStatementImpl extends NamedElementImpl implements EqStatement
{
  ...
  public EList<Arg> getArgs()
  {
    if (args == null)
    {
      args = new EObjectContainmentEList<Arg>(Arg.class, this, AgreePackage.EQ_STATEMENT__ARGS);
    }
    return args;
  }
