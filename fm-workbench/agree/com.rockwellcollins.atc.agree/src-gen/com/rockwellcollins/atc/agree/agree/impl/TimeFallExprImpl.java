...
public class TimeFallExprImpl extends ExprImpl implements TimeFallExpr
{
    ...
    if (id != null && ((EObject)id).eIsProxy())
    {
      ...
      if (id != oldId)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.TIME_FALL_EXPR__ID, oldId, id));
      }
    }
    return id;
  }
  ...
  public void setId(NamedElement newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.TIME_FALL_EXPR__ID, oldId, id));
  }
