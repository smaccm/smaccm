...
public class TimeFallExprImpl extends ExprImpl implements TimeFallExpr
{
  ...
  public NotificationChain basicSetId(NestedDotID newId, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.TIME_FALL_EXPR__ID, oldId, newId);
  ...
  public void setId(NestedDotID newId)
  {
    if (newId != id)
    {
      ...
      if (id != null)
        msgs = ((InternalEObject)id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgreePackage.TIME_FALL_EXPR__ID, null, msgs);
      if (newId != null)
        msgs = ((InternalEObject)newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgreePackage.TIME_FALL_EXPR__ID, null, msgs);
