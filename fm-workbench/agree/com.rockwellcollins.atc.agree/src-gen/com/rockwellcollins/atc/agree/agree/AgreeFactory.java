...
public interface AgreeFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Chain ID</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Chain ID</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Base ID</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Base ID</em>'.
   * @generated
   */
  BaseID createBaseID();

  /**
   * Returns a new object of class '<em>Record Proj</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Record Proj</em>'.
   * @generated
   */
  RecordProj createRecordProj();
