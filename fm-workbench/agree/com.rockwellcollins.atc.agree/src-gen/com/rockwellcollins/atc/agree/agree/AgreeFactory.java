...
public interface AgreeFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Abstraction Ref</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Abstraction Ref</em>'.
   * @generated
   */
  AbstractionRef createAbstractionRef();

  /**
   * Returns a new object of class '<em>Enum ID</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Enum ID</em>'.
   * @generated
   */
  EnumID createEnumID();
  ...
  /**
   * Returns a new object of class '<em>Subcomponent Ref</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Subcomponent Ref</em>'.
   * @generated
   */
  SubcomponentRef createSubcomponentRef();
