...
public class AgreeGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NestedDotIDElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cChainIDAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cChainIDChainIDParserRuleCall_0_0 = (RuleCall)cChainIDAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Group cGroup_1_0 = (Group)cGroup_1.eContents().get(0);
		private final Keyword cFullStopKeyword_1_0_0 = (Keyword)cGroup_1_0.eContents().get(0);
		private final Assignment cTagAssignment_1_0_1 = (Assignment)cGroup_1_0.eContents().get(1);
		private final RuleCall cTagReservedVarTagParserRuleCall_1_0_1_0 = (RuleCall)cTagAssignment_1_0_1.eContents().get(0);
		
		////NestedDotID:
		////	base=[aadl2::NamedElement|QCPREF] (=> ('.' (( tag=ReservedVarTag) | sub=NestedDotID)))?;
		//NestedDotID:
		//	chainID=ChainID => ('.' tag=ReservedVarTag)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//chainID=ChainID
		public Assignment getChainIDAssignment_0() { return cChainIDAssignment_0; }

		//ChainID
		public RuleCall getChainIDChainIDParserRuleCall_0_0() { return cChainIDChainIDParserRuleCall_0_0; }
		...
		//tag=ReservedVarTag
		public Assignment getTagAssignment_1_0_1() { return cTagAssignment_1_0_1; }

		//ReservedVarTag
		public RuleCall getTagReservedVarTagParserRuleCall_1_0_1_0() { return cTagReservedVarTagParserRuleCall_1_0_1_0; }
	}

	public class ChainIDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.rockwellcollins.atc.agree.Agree.ChainID");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Action cBaseIDAction_0_0 = (Action)cGroup_0.eContents().get(0);
		private final Assignment cNamedElmAssignment_0_1 = (Assignment)cGroup_0.eContents().get(1);
		private final CrossReference cNamedElmNamedElementCrossReference_0_1_0 = (CrossReference)cNamedElmAssignment_0_1.eContents().get(0);
		private final RuleCall cNamedElmNamedElementQCPREFParserRuleCall_0_1_0_1 = (RuleCall)cNamedElmNamedElementCrossReference_0_1_0.eContents().get(1);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Group cGroup_1_0 = (Group)cGroup_1.eContents().get(0);
		private final Action cRecordProjChainIDAction_1_0_0 = (Action)cGroup_1_0.eContents().get(0);
		private final Keyword cFullStopKeyword_1_0_1 = (Keyword)cGroup_1_0.eContents().get(1);
		private final Assignment cNamedElmAssignment_1_0_2 = (Assignment)cGroup_1_0.eContents().get(2);
		private final CrossReference cNamedElmNamedElementCrossReference_1_0_2_0 = (CrossReference)cNamedElmAssignment_1_0_2.eContents().get(0);
		private final RuleCall cNamedElmNamedElementQCPREFParserRuleCall_1_0_2_0_1 = (RuleCall)cNamedElmNamedElementCrossReference_1_0_2_0.eContents().get(1);
		
		//ChainID:
		//	({BaseID} namedElm=[aadl2::NamedElement|QCPREF]) => ({RecordProj.chainID=current} '.'
		...
		//{BaseID} namedElm=[aadl2::NamedElement|QCPREF]
		public Group getGroup_0() { return cGroup_0; }

		//{BaseID}
		public Action getBaseIDAction_0_0() { return cBaseIDAction_0_0; }

		//namedElm=[aadl2::NamedElement|QCPREF]
		public Assignment getNamedElmAssignment_0_1() { return cNamedElmAssignment_0_1; }

		//[aadl2::NamedElement|QCPREF]
		public CrossReference getNamedElmNamedElementCrossReference_0_1_0() { return cNamedElmNamedElementCrossReference_0_1_0; }

		//QCPREF
		public RuleCall getNamedElmNamedElementQCPREFParserRuleCall_0_1_0_1() { return cNamedElmNamedElementQCPREFParserRuleCall_0_1_0_1; }

		//=> ({RecordProj.chainID=current} '.' namedElm=[aadl2::NamedElement|QCPREF])*
		public Group getGroup_1() { return cGroup_1; }

		//{RecordProj.chainID=current} '.' namedElm=[aadl2::NamedElement|QCPREF]
		public Group getGroup_1_0() { return cGroup_1_0; }

		//{RecordProj.chainID=current}
		public Action getRecordProjChainIDAction_1_0_0() { return cRecordProjChainIDAction_1_0_0; }

		//'.'
		public Keyword getFullStopKeyword_1_0_1() { return cFullStopKeyword_1_0_1; }

		//namedElm=[aadl2::NamedElement|QCPREF]
		public Assignment getNamedElmAssignment_1_0_2() { return cNamedElmAssignment_1_0_2; }

		//[aadl2::NamedElement|QCPREF]
		public CrossReference getNamedElmNamedElementCrossReference_1_0_2_0() { return cNamedElmNamedElementCrossReference_1_0_2_0; }

		//QCPREF
		public RuleCall getNamedElmNamedElementQCPREFParserRuleCall_1_0_2_0_1() { return cNamedElmNamedElementQCPREFParserRuleCall_1_0_2_0_1; }
	}
	...
	private final ChainIDElements pChainID;
	...
	public AgreeGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pChainID = new ChainIDElements();
	...
	//	({BaseID} namedElm=[aadl2::NamedElement|QCPREF]) => ({RecordProj.chainID=current} '.'
	//	namedElm=[aadl2::NamedElement|QCPREF])*;
	public ChainIDElements getChainIDAccess() {
		return pChainID;
	}
	
	public ParserRule getChainIDRule() {
		return getChainIDAccess().getRule();
	}
