...
public class SporadicStatementImpl extends RealTimeStatementImpl implements SporadicStatement {
	...
	public NotificationChain basicSetIat(Expr newIat, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.SPORADIC_STATEMENT__IAT, oldIat, newIat);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setIat(Expr newIat) {
		if (newIat != iat) {
			...
			if (iat != null) {
				msgs = ((InternalEObject) iat).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.SPORADIC_STATEMENT__IAT, null, msgs);
			}
			if (newIat != null) {
				msgs = ((InternalEObject) newIat).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.SPORADIC_STATEMENT__IAT, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.SPORADIC_STATEMENT__IAT, newIat,
					newIat));
		}
	}
