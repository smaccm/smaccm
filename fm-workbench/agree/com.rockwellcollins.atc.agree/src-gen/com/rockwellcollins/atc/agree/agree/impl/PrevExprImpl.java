...
public class PrevExprImpl extends ExprImpl implements PrevExpr {
		...
		if (newDelay != delay) {
			...
			if (delay != null) {
				msgs = ((InternalEObject) delay).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.PREV_EXPR__DELAY, null, msgs);
			}
			if (newDelay != null) {
	...
	public NotificationChain basicSetInit(Expr newInit, NotificationChain msgs) {
		...
		init = newInit;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.PREV_EXPR__INIT,
					oldInit, newInit);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newInit != init) {
			...
			if (init != null) {
				msgs = ((InternalEObject) init).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.PREV_EXPR__INIT, null, msgs);
			}
			if (newInit != null) {
