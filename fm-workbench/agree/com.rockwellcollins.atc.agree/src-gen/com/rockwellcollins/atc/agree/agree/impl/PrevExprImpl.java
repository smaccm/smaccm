 ...
 * <em><b>Prev Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.PrevExprImpl#getDelay
 * <em>Delay</em>}</li>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.PrevExprImpl#getInit <em>
 * Init</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PrevExprImpl extends ExprImpl implements PrevExpr {
    ...
    /**
     * The cached value of the '{@link #getInit() <em>Init</em>}' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getInit()
     * @generated
    ...
    public NotificationChain basicSetDelay(Expr newDelay, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PREV_EXPR__DELAY, oldDelay, newDelay);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setDelay(Expr newDelay) {
        if (newDelay != delay) {
            ...
            if (delay != null) {
                msgs = ((InternalEObject) delay).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PREV_EXPR__DELAY, null, msgs);
            }
            if (newDelay != null) {
                msgs = ((InternalEObject) newDelay).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PREV_EXPR__DELAY, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PREV_EXPR__DELAY,
                    newDelay, newDelay));
        }
    }
    ...
    public NotificationChain basicSetInit(Expr newInit, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PREV_EXPR__INIT, oldInit, newInit);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newInit != init) {
            ...
            if (init != null) {
                msgs = ((InternalEObject) init).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PREV_EXPR__INIT, null, msgs);
            }
            if (newInit != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PREV_EXPR__INIT,
                    newInit, newInit));
        }
    }
