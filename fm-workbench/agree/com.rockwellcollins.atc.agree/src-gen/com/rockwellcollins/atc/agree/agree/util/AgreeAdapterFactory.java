...
public class AgreeAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AgreeSwitch<Adapter> modelSwitch =
    new AgreeSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseChainID(ChainID object)
      {
        return createChainIDAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseBaseID(BaseID object)
      {
        return createBaseIDAdapter();
      }
      @Override
      public Adapter caseRecordProj(RecordProj object)
      {
        return createRecordProjAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.rockwellcollins.atc.agree.agree.ChainID <em>Chain ID</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createChainIDAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.rockwellcollins.atc.agree.agree.BaseID <em>Base ID</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createBaseIDAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link com.rockwellcollins.atc.agree.agree.RecordProj <em>Record Proj</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createRecordProjAdapter()
  {
    return null;
  }
