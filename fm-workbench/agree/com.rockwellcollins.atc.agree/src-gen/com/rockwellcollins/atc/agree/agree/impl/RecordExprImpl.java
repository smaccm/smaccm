...
public class RecordExprImpl extends ComplexExprImpl implements RecordExpr {
	...
	public NotificationChain basicSetRecord(NestedDotID newRecord, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.RECORD_EXPR__RECORD, oldRecord, newRecord);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newRecord != record) {
			...
			if (record != null) {
				msgs = ((InternalEObject) record).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.RECORD_EXPR__RECORD, null, msgs);
			}
			if (newRecord != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.RECORD_EXPR__RECORD, newRecord,
					newRecord));
		}
	}
	...
	public EList<NamedElement> getArgs() {
		if (args == null) {
			args = new EObjectResolvingEList<>(NamedElement.class, this, AgreePackage.RECORD_EXPR__ARGS);
		}
		return args;
	}
	...
	public EList<Expr> getArgExpr() {
		if (argExpr == null) {
			argExpr = new EObjectContainmentEList<>(Expr.class, this, AgreePackage.RECORD_EXPR__ARG_EXPR);
		}
		return argExpr;
	}
