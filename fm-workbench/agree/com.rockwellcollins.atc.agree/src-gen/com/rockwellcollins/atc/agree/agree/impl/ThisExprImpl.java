...
public class ThisExprImpl extends ExprImpl implements ThisExpr {
	...
	public NotificationChain basicSetSubThis(NestedDotID newSubThis, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.THIS_EXPR__SUB_THIS, oldSubThis, newSubThis);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setSubThis(NestedDotID newSubThis) {
		if (newSubThis != subThis) {
			...
			if (subThis != null) {
				msgs = ((InternalEObject) subThis).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.THIS_EXPR__SUB_THIS, null, msgs);
			}
			if (newSubThis != null) {
				msgs = ((InternalEObject) newSubThis).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.THIS_EXPR__SUB_THIS, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.THIS_EXPR__SUB_THIS, newSubThis,
					newSubThis));
		}
	}
