...
public class TimeIntervalImpl extends MinimalEObjectImpl.Container implements TimeInterval {
	...
	public NotificationChain basicSetLow(Expr newLow, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.TIME_INTERVAL__LOW, oldLow, newLow);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newLow != low) {
			...
			if (low != null) {
				msgs = ((InternalEObject) low).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.TIME_INTERVAL__LOW, null, msgs);
			}
			if (newLow != null) {
	...
	public NotificationChain basicSetHigh(Expr newHigh, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.TIME_INTERVAL__HIGH, oldHigh, newHigh);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newHigh != high) {
			...
			if (high != null) {
				msgs = ((InternalEObject) high).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.TIME_INTERVAL__HIGH, null, msgs);
			}
			if (newHigh != null) {
