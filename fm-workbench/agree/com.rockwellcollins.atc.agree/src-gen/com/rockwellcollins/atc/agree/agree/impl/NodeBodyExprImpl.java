...
public class NodeBodyExprImpl extends ElementImpl implements NodeBodyExpr {
	...
	public EList<Arg> getLocs() {
		if (locs == null) {
			locs = new EObjectContainmentEList<>(Arg.class, this, AgreePackage.NODE_BODY_EXPR__LOCS);
		}
		return locs;
	}
	...
	public EList<NodeStmt> getStmts() {
		if (stmts == null) {
			stmts = new EObjectContainmentEList<>(NodeStmt.class, this, AgreePackage.NODE_BODY_EXPR__STMTS);
		}
		return stmts;
	}
