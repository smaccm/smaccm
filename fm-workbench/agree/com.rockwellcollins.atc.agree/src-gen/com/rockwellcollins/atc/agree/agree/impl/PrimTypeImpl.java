...
public class PrimTypeImpl extends TypeImpl implements PrimType {
	...
	public void setRangeLow(String newRangeLow) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PRIM_TYPE__RANGE_LOW, oldRangeLow,
					rangeLow));
		}
	}
	...
	public void setHighNeg(String newHighNeg) {
		...
		highNeg = newHighNeg;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PRIM_TYPE__HIGH_NEG, oldHighNeg,
					highNeg));
		}
	}
	...
	public void setRangeHigh(String newRangeHigh) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PRIM_TYPE__RANGE_HIGH, oldRangeHigh,
					rangeHigh));
		}
	}
