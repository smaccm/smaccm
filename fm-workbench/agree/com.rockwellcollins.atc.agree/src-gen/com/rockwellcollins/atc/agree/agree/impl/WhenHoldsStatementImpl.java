...
public class WhenHoldsStatementImpl extends WhenStatementImpl implements WhenHoldsStatement {
	...
	public NotificationChain basicSetConditionInterval(TimeInterval newConditionInterval, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_HOLDS_STATEMENT__CONDITION_INTERVAL, oldConditionInterval, newConditionInterval);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setConditionInterval(TimeInterval newConditionInterval) {
		if (newConditionInterval != conditionInterval) {
			...
			if (conditionInterval != null) {
				msgs = ((InternalEObject) conditionInterval).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_HOLDS_STATEMENT__CONDITION_INTERVAL, null, msgs);
			}
			if (newConditionInterval != null) {
				msgs = ((InternalEObject) newConditionInterval).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_HOLDS_STATEMENT__CONDITION_INTERVAL, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_HOLDS_STATEMENT__CONDITION_INTERVAL,
					newConditionInterval, newConditionInterval));
		}
	}
	...
	public NotificationChain basicSetEventInterval(TimeInterval newEventInterval, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHEN_HOLDS_STATEMENT__EVENT_INTERVAL, oldEventInterval, newEventInterval);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setEventInterval(TimeInterval newEventInterval) {
		if (newEventInterval != eventInterval) {
			...
			if (eventInterval != null) {
				msgs = ((InternalEObject) eventInterval).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_HOLDS_STATEMENT__EVENT_INTERVAL, null, msgs);
			}
			if (newEventInterval != null) {
				msgs = ((InternalEObject) newEventInterval).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHEN_HOLDS_STATEMENT__EVENT_INTERVAL, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHEN_HOLDS_STATEMENT__EVENT_INTERVAL,
					newEventInterval, newEventInterval));
		}
	}
