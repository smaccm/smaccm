...
public class IfThenElseExprImpl extends ExprImpl implements IfThenElseExpr {
	...
	public void setA(Expr newA) {
		if (newA != a) {
			...
			if (a != null) {
				msgs = ((InternalEObject) a).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.IF_THEN_ELSE_EXPR__A, null, msgs);
			}
			if (newA != null) {
				msgs = ((InternalEObject) newA).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.IF_THEN_ELSE_EXPR__A, null, msgs);
			}
		...
		if (newB != b) {
			...
			if (b != null) {
				msgs = ((InternalEObject) b).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.IF_THEN_ELSE_EXPR__B, null, msgs);
			}
			if (newB != null) {
		...
		if (newC != c) {
			...
			if (c != null) {
				msgs = ((InternalEObject) c).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.IF_THEN_ELSE_EXPR__C, null, msgs);
			}
			if (newC != null) {
