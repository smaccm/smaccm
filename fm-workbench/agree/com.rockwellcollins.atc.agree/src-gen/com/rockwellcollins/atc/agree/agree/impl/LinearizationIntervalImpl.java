...
public class LinearizationIntervalImpl extends ElementImpl implements LinearizationInterval {
	...
	public NotificationChain basicSetStart(Expr newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LINEARIZATION_INTERVAL__START, oldStart, newStart);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newStart != start) {
			...
			if (start != null) {
				msgs = ((InternalEObject) start).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_INTERVAL__START, null, msgs);
			}
			if (newStart != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_INTERVAL__START, newStart,
					newStart));
		}
	}
	...
	public NotificationChain basicSetEnd(Expr newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LINEARIZATION_INTERVAL__END, oldEnd, newEnd);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newEnd != end) {
			...
			if (end != null) {
				msgs = ((InternalEObject) end).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_INTERVAL__END, null, msgs);
			}
			if (newEnd != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_INTERVAL__END, newEnd,
					newEnd));
		}
	}
