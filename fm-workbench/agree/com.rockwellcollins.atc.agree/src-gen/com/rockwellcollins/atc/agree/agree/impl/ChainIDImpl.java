...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Chain ID</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.impl.ChainIDImpl#getNamedElm <em>Named Elm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChainIDImpl extends MinimalEObjectImpl.Container implements ChainID
{
  /**
  ...
  {
    return AgreePackage.Literals.CHAIN_ID;
  }
    ...
    if (namedElm != null && ((EObject)namedElm).eIsProxy())
    {
      ...
      if (namedElm != oldNamedElm)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.CHAIN_ID__NAMED_ELM, oldNamedElm, namedElm));
      }
    }
    return namedElm;
  }
  ...
  public void setNamedElm(NamedElement newNamedElm)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.CHAIN_ID__NAMED_ELM, oldNamedElm, namedElm));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AgreePackage.CHAIN_ID__NAMED_ELM:
