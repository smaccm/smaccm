...
public class AssignStatementImpl extends SpecStatementImpl implements AssignStatement {
	...
	public NotificationChain basicSetId(NestedDotID newId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.ASSIGN_STATEMENT__ID, oldId, newId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newId != id) {
			...
			if (id != null) {
				msgs = ((InternalEObject) id).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.ASSIGN_STATEMENT__ID, null, msgs);
			}
			if (newId != null) {
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.ASSIGN_STATEMENT__EXPR, oldExpr, newExpr);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.ASSIGN_STATEMENT__EXPR, null, msgs);
			}
			if (newExpr != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.ASSIGN_STATEMENT__EXPR, newExpr,
					newExpr));
		}
	}
