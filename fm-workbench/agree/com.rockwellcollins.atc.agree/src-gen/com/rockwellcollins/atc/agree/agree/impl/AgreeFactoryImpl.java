...
public class AgreeFactoryImpl extends EFactoryImpl implements AgreeFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case AgreePackage.CUSTOM_TYPE: return createCustomType();
      ...
      case AgreePackage.ABSTRACTION_REF: return createAbstractionRef();
      case AgreePackage.ENUM_ID: return createEnumID();
      ...
      case AgreePackage.SUBCOMPONENT_REF: return createSubcomponentRef();
   ...
   * @generated
   */
  public AbstractionRef createAbstractionRef()
  {
    AbstractionRefImpl abstractionRef = new AbstractionRefImpl();
  ...
  {
    EnumIDImpl enumID = new EnumIDImpl();
    return enumID;
  }
   ...
   * @generated
   */
  public SubcomponentRef createSubcomponentRef()
  {
    SubcomponentRefImpl subcomponentRef = new SubcomponentRefImpl();
