...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Latched Expr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LatchedExprImpl extends ExprImpl implements LatchedExpr {
	...
	protected EClass eStaticClass() {
		return AgreePackage.Literals.LATCHED_EXPR;
	}
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LATCHED_EXPR__EXPR, oldExpr, newExpr);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LATCHED_EXPR__EXPR, null, msgs);
			}
			if (newExpr != null) {
