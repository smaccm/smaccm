...
public interface AgreePackage extends EPackage
{
   ...
   * @ordered
   */
  int REAL_TIME_STATEMENT_FEATURE_COUNT = PATTERN_STATEMENT_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link com.rockwellcollins.atc.agree.agree.impl.EventStatementImpl <em>Event Statement</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.rockwellcollins.atc.agree.agree.impl.EventStatementImpl
   * @see com.rockwellcollins.atc.agree.agree.impl.AgreePackageImpl#getEventStatement()
   * @generated
   */
   ...
   * @ordered
   */
  int EVENT_STATEMENT__OWNED_ELEMENT = Aadl2Package.NAMED_ELEMENT__OWNED_ELEMENT;
   ...
   * @ordered
   */
  int EVENT_STATEMENT__OWNED_COMMENT = Aadl2Package.NAMED_ELEMENT__OWNED_COMMENT;
   ...
   * @ordered
   */
  int EVENT_STATEMENT__NAME = Aadl2Package.NAMED_ELEMENT__NAME;
   ...
   * @ordered
   */
  int EVENT_STATEMENT__QUALIFIED_NAME = Aadl2Package.NAMED_ELEMENT__QUALIFIED_NAME;
   ...
   * @ordered
   */
  int EVENT_STATEMENT__OWNED_PROPERTY_ASSOCIATION = Aadl2Package.NAMED_ELEMENT__OWNED_PROPERTY_ASSOCIATION;
   ...
   * @ordered
   */
  int EVENT_STATEMENT_FEATURE_COUNT = Aadl2Package.NAMED_ELEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int PERIODIC_STATEMENT__EVENT = REAL_TIME_STATEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int PERIODIC_STATEMENT__PERIOD = REAL_TIME_STATEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int PERIODIC_STATEMENT__JITTER = REAL_TIME_STATEMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int PERIODIC_STATEMENT_FEATURE_COUNT = REAL_TIME_STATEMENT_FEATURE_COUNT + 3;
   ...
   * @generated
   */
  int OPEN_LEFT_TIME_INTERVAL = 47;
   ...
   * @generated
   */
  int OPEN_RIGHT_TIME_INTERVAL = 48;
  ...
  /**
   * Returns the meta object for class '{@link com.rockwellcollins.atc.agree.agree.EventStatement <em>Event Statement</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Event Statement</em>'.
   * @see com.rockwellcollins.atc.agree.agree.EventStatement
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link com.rockwellcollins.atc.agree.agree.PeriodicStatement#getEvent <em>Event</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Event</em>'.
   * @see com.rockwellcollins.atc.agree.agree.PeriodicStatement#getEvent()
   * @see #getPeriodicStatement()
   * @generated
   */
  EReference getPeriodicStatement_Event();
  ...
  /**
   * Returns the meta object for the containment reference '{@link com.rockwellcollins.atc.agree.agree.PeriodicStatement#getJitter <em>Jitter</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Jitter</em>'.
   * @see com.rockwellcollins.atc.agree.agree.PeriodicStatement#getJitter()
   * @see #getPeriodicStatement()
   * @generated
   */
  EReference getPeriodicStatement_Jitter();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link com.rockwellcollins.atc.agree.agree.impl.EventStatementImpl <em>Event Statement</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.rockwellcollins.atc.agree.agree.impl.EventStatementImpl
     * @see com.rockwellcollins.atc.agree.agree.impl.AgreePackageImpl#getEventStatement()
     ...
     * @generated
     */
    EReference PERIODIC_STATEMENT__EVENT = eINSTANCE.getPeriodicStatement_Event();
     ...
     * @generated
     */
    EReference PERIODIC_STATEMENT__JITTER = eINSTANCE.getPeriodicStatement_Jitter();
