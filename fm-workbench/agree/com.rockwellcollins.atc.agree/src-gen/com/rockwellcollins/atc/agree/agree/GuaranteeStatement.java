 ...
 * </p>
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.agree.agree.GuaranteeStatement#getId <em>Id</em>}</li>
...
public interface GuaranteeStatement extends SpecStatement
{
   ...
   * @see #setId(String)
   * @see com.rockwellcollins.atc.agree.agree.AgreePackage#getGuaranteeStatement_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link com.rockwellcollins.atc.agree.agree.GuaranteeStatement#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
