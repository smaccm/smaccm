...
public class LinearizationDefExprImpl extends NamedElementImpl implements LinearizationDefExpr {
	...
	public EList<Arg> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<>(Arg.class, this, AgreePackage.LINEARIZATION_DEF_EXPR__ARGS);
		}
		return args;
	}
	...
	public EList<LinearizationInterval> getIntervals() {
		if (intervals == null) {
			intervals = new EObjectContainmentEList<>(LinearizationInterval.class, this,
					AgreePackage.LINEARIZATION_DEF_EXPR__INTERVALS);
		}
		return intervals;
	}
	...
	public NotificationChain basicSetPrecision(Expr newPrecision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, oldPrecision, newPrecision);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newPrecision != precision) {
			...
			if (precision != null) {
				msgs = ((InternalEObject) precision).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION,
	...
	public NotificationChain basicSetExprBody(Expr newExprBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, oldExprBody, newExprBody);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setExprBody(Expr newExprBody) {
		if (newExprBody != exprBody) {
			NotificationChain msgs = null;
			if (exprBody != null) {
				msgs = ((InternalEObject) exprBody).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, null, msgs);
			}
			if (newExprBody != null) {
				msgs = ((InternalEObject) newExprBody).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY,
					newExprBody, newExprBody));
		}
	}
