...
public class LinearizationDefExprImpl extends NamedElementImpl implements LinearizationDefExpr
{
   ...
   * @generated
   */
  protected LinearizationDefExprImpl()
  {
    super();
  }
  ...
  public EList<LinearizationInterval> getIntervals()
  {
    if (intervals == null)
    {
      intervals = new EObjectContainmentEList<LinearizationInterval>(LinearizationInterval.class, this, AgreePackage.LINEARIZATION_DEF_EXPR__INTERVALS);
    }
    return intervals;
  }
  ...
  public NotificationChain basicSetPrecision(Expr newPrecision, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, oldPrecision, newPrecision);
  ...
  public void setPrecision(Expr newPrecision)
  {
    if (newPrecision != precision)
    {
      ...
      if (precision != null)
        msgs = ((InternalEObject)precision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, null, msgs);
      if (newPrecision != null)
        msgs = ((InternalEObject)newPrecision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, null, msgs);
      msgs = basicSetPrecision(newPrecision, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__PRECISION, newPrecision, newPrecision));
  }
  ...
  public NotificationChain basicSetExprBody(Expr newExprBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, oldExprBody, newExprBody);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExprBody(Expr newExprBody)
  {
    if (newExprBody != exprBody)
    {
      NotificationChain msgs = null;
      if (exprBody != null)
        msgs = ((InternalEObject)exprBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, null, msgs);
      if (newExprBody != null)
        msgs = ((InternalEObject)newExprBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, null, msgs);
      msgs = basicSetExprBody(newExprBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY, newExprBody, newExprBody));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case AgreePackage.LINEARIZATION_DEF_EXPR__EXPR_BODY:
