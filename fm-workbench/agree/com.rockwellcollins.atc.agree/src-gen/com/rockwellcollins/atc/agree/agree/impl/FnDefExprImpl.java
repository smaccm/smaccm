 ...
 * <em><b>Fn Def Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.FnDefExprImpl#getArgs
 * <em>Args</em>}</li>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.FnDefExprImpl#getType
 * <em>Type</em>}</li>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.FnDefExprImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 * </p>
 * 
...
public class FnDefExprImpl extends NamedElementImpl implements FnDefExpr {
    ...
    public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.FN_DEF_EXPR__TYPE, oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.FN_DEF_EXPR__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.FN_DEF_EXPR__TYPE,
                    newType, newType));
        }
    }
    ...
    public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.FN_DEF_EXPR__EXPR, oldExpr, newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.FN_DEF_EXPR__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.FN_DEF_EXPR__EXPR,
                    newExpr, newExpr));
        }
    }
