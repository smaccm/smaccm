...
public class FnDefExprImpl extends NamedElementImpl implements FnDefExpr {
	...
	public EList<Arg> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<>(Arg.class, this, AgreePackage.FN_DEF_EXPR__ARGS);
		}
		return args;
	}
		...
		if (newType != type) {
			...
			if (type != null) {
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.FN_DEF_EXPR__TYPE, null, msgs);
			}
			if (newType != null) {
		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.FN_DEF_EXPR__EXPR, null, msgs);
			}
			if (newExpr != null) {
