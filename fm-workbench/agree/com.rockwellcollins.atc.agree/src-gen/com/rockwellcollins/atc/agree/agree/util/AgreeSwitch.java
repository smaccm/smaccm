...
public class AgreeSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case AgreePackage.CHAIN_ID:
      {
        ChainID chainID = (ChainID)theEObject;
        T result = caseChainID(chainID);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case AgreePackage.BASE_ID:
      {
        BaseID baseID = (BaseID)theEObject;
        T result = caseBaseID(baseID);
        if (result == null) result = caseChainID(baseID);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case AgreePackage.RECORD_PROJ:
      {
        RecordProj recordProj = (RecordProj)theEObject;
        T result = caseRecordProj(recordProj);
        if (result == null) result = caseChainID(recordProj);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Chain ID</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Chain ID</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseChainID(ChainID object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Base ID</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Base ID</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBaseID(BaseID object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Record Proj</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Record Proj</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRecordProj(RecordProj object)
  {
    return null;
  }
