...
public class AgreeSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case AgreePackage.ABSTRACTION_REF:
      {
        AbstractionRef abstractionRef = (AbstractionRef)theEObject;
        T result = caseAbstractionRef(abstractionRef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case AgreePackage.ENUM_ID:
      {
        EnumID enumID = (EnumID)theEObject;
        T result = caseEnumID(enumID);
        if (result == null) result = caseNamedElement(enumID);
        if (result == null) result = caseElement(enumID);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case AgreePackage.SUBCOMPONENT_REF:
      {
        SubcomponentRef subcomponentRef = (SubcomponentRef)theEObject;
        T result = caseSubcomponentRef(subcomponentRef);
        if (result == null) result = caseComponentRef(subcomponentRef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Abstraction Ref</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Abstraction Ref</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAbstractionRef(AbstractionRef object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Enum ID</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Enum ID</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEnumID(EnumID object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Subcomponent Ref</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Subcomponent Ref</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSubcomponentRef(SubcomponentRef object)
  {
    return null;
  }
