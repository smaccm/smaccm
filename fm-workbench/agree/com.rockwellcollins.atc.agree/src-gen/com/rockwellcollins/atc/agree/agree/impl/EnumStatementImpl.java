...
public class EnumStatementImpl extends NamedElementImpl implements EnumStatement
{
   ...
   * @generated
   */
  public EList<EnumID> getEnums()
  {
    if (enums == null)
    {
      enums = new EObjectContainmentEList<EnumID>(EnumID.class, this, AgreePackage.ENUM_STATEMENT__ENUMS);
    }
    return enums;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case AgreePackage.ENUM_STATEMENT__ENUMS:
        getEnums().clear();
        getEnums().addAll((Collection<? extends EnumID>)newValue);
        return;
    }
