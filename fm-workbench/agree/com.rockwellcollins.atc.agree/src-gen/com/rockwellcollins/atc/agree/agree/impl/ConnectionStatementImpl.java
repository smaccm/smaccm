...
public class ConnectionStatementImpl extends SpecStatementImpl implements ConnectionStatement {
		...
		if (conn != null && ((EObject) conn).eIsProxy()) {
			...
			if (conn != oldConn) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.CONNECTION_STATEMENT__CONN,
							oldConn, conn));
				}
			}
		}
	...
	public void setConn(NamedElement newConn) {
		...
		conn = newConn;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.CONNECTION_STATEMENT__CONN, oldConn,
					conn));
		}
	}
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.CONNECTION_STATEMENT__EXPR, oldExpr, newExpr);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.CONNECTION_STATEMENT__EXPR, null, msgs);
			}
			if (newExpr != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.CONNECTION_STATEMENT__EXPR, newExpr,
					newExpr));
		}
	}
