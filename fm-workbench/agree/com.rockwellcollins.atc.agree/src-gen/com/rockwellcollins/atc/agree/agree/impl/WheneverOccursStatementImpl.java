	...
	public NotificationChain basicSetEffect(Expr newEffect, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.WHENEVER_OCCURS_STATEMENT__EFFECT, oldEffect, newEffect);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newEffect != effect) {
			...
			if (effect != null) {
				msgs = ((InternalEObject) effect).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.WHENEVER_OCCURS_STATEMENT__EFFECT, null, msgs);
			}
			if (newEffect != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.WHENEVER_OCCURS_STATEMENT__EFFECT,
					newEffect, newEffect));
		}
	}
