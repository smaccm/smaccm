...
public class MNSynchStatementImpl extends SynchStatementImpl implements MNSynchStatement {
	...
	public EList<NamedElement> getComp1() {
		if (comp1 == null) {
			comp1 = new EObjectResolvingEList<>(NamedElement.class, this, AgreePackage.MN_SYNCH_STATEMENT__COMP1);
		}
		return comp1;
	}
	...
	public EList<NamedElement> getComp2() {
		if (comp2 == null) {
			comp2 = new EObjectResolvingEList<>(NamedElement.class, this, AgreePackage.MN_SYNCH_STATEMENT__COMP2);
		}
		return comp2;
	}
	...
	public EList<String> getMax() {
		if (max == null) {
			max = new EDataTypeEList<>(String.class, this, AgreePackage.MN_SYNCH_STATEMENT__MAX);
		}
		return max;
	}
	...
	public EList<String> getMin() {
		if (min == null) {
			min = new EDataTypeEList<>(String.class, this, AgreePackage.MN_SYNCH_STATEMENT__MIN);
		}
		return min;
	}
