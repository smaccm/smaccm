...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQuantAccess().getForallKeyword_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQuantAccess().getExistsKeyword_1()); 
    }
)
    ;
...
ruleExpr returns [EObject current=null] 
    ...
    { 
        newCompositeNode(grammarAccess.getExprAccess().getQuantExprParserRuleCall()); 
    }
    this_QuantExpr_0=ruleQuantExpr
    {
        $current = $this_QuantExpr_0.current;
        afterParserOrEnumRuleCall();
    }
...
entryRuleQuantExpr returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getQuantExprRule()); }
	 iv_ruleQuantExpr=ruleQuantExpr 
	 { $current=$iv_ruleQuantExpr.current; } 
	 EOF 
;

// Rule QuantExpr
ruleQuantExpr returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
(
    ...
    {
        $current = $this_ArrayAccessExpr_0.current;
        afterParserOrEnumRuleCall();
    }
((((
)(
...
entryRuleArrayAccessExpr returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getArrayAccessExprRule()); }
	 iv_ruleArrayAccessExpr=ruleArrayAccessExpr 
	 { $current=$iv_ruleArrayAccessExpr.current; } 
	 EOF 
;

// Rule ArrayAccessExpr
ruleArrayAccessExpr returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
(
	...
	otherlv_25=Floor
    {
    	newLeafNode(otherlv_25, grammarAccess.getTermExprAccess().getFloorKeyword_7_1());
    }

	otherlv_26=LeftParenthesis
    {
    	newLeafNode(otherlv_26, grammarAccess.getTermExprAccess().getLeftParenthesisKeyword_7_2());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_28, grammarAccess.getTermExprAccess().getRightParenthesisKeyword_7_4());
    }
)
    |((
    {
	...
	otherlv_30=Real
    {
    	newLeafNode(otherlv_30, grammarAccess.getTermExprAccess().getRealKeyword_8_1());
    }

	otherlv_31=LeftParenthesis
    {
    	newLeafNode(otherlv_31, grammarAccess.getTermExprAccess().getLeftParenthesisKeyword_8_2());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_33, grammarAccess.getTermExprAccess().getRightParenthesisKeyword_8_4());
    }
)
    |((
    {
...
(
		lv_val_35_0=RULE_REAL_LIT
		{
			newLeafNode(lv_val_35_0, grammarAccess.getTermExprAccess().getValREAL_LITTerminalRuleCall_9_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getTermExprRule());
...
(
		...
		lv_val_37_0=ruleBooleanLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTermExprRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_38, grammarAccess.getTermExprAccess().getLeftParenthesisKeyword_11_0());
    }
    ...
    {
    	newLeafNode(otherlv_40, grammarAccess.getTermExprAccess().getRightParenthesisKeyword_11_2());
    }
))
;
