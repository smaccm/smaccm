 ...
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.IdExprImpl#getId <em>Id
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class IdExprImpl extends ExprImpl implements IdExpr {
            ...
            if (id != oldId) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            AgreePackage.ID_EXPR__ID, oldId, id));
                }
            }
        }
        return id;
    ...
    public void setId(NamedElement newId) {
        ...
        id = newId;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.ID_EXPR__ID, oldId,
                    id));
        }
    }
