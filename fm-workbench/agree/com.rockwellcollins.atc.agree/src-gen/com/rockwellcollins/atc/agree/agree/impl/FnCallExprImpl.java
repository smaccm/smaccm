...
public class FnCallExprImpl extends ExprImpl implements FnCallExpr
{
    ...
    if (fn != null && fn.eIsProxy())
    {
      ...
      if (fn != oldFn)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.FN_CALL_EXPR__FN, oldFn, fn));
      }
    }
    return fn;
  }
  ...
  public void setFn(CallDef newFn)
  {
    ...
    fn = newFn;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.FN_CALL_EXPR__FN, oldFn, fn));
  }
