...
public class FnCallExprImpl extends ComplexExprImpl implements FnCallExpr {
	...
	public NotificationChain basicSetFn(NestedDotID newFn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.FN_CALL_EXPR__FN, oldFn, newFn);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setFn(NestedDotID newFn) {
		if (newFn != fn) {
			...
			if (fn != null) {
				msgs = ((InternalEObject) fn).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.FN_CALL_EXPR__FN, null, msgs);
			}
			if (newFn != null) {
				msgs = ((InternalEObject) newFn).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.FN_CALL_EXPR__FN, null, msgs);
			}
	...
	public EList<Expr> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<>(Expr.class, this, AgreePackage.FN_CALL_EXPR__ARGS);
		}
		return args;
	}
