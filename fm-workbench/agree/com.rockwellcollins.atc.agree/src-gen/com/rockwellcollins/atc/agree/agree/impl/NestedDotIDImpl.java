...
public class NestedDotIDImpl extends ComplexExprImpl implements NestedDotID {
		...
		if (base != null && ((EObject) base).eIsProxy()) {
			...
			if (base != oldBase) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgreePackage.NESTED_DOT_ID__BASE, oldBase,
							base));
				}
			}
		}
	...
	public NotificationChain basicSetSub(NestedDotID newSub, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.NESTED_DOT_ID__SUB, oldSub, newSub);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setSub(NestedDotID newSub) {
		if (newSub != sub) {
			...
			if (sub != null) {
				msgs = ((InternalEObject) sub).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.NESTED_DOT_ID__SUB, null, msgs);
			}
			if (newSub != null) {
				msgs = ((InternalEObject) newSub).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.NESTED_DOT_ID__SUB, null, msgs);
			}
