 ...
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.NestedDotIDImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.NestedDotIDImpl#getSubName
 * <em>Sub Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public class NestedDotIDImpl extends MinimalEObjectImpl.Container implements NestedDotID {
    ...
    /**
     * The cached value of the '{@link #getSubName() <em>Sub Name</em>}'
            ...
            if (name != oldName) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            AgreePackage.NESTED_DOT_ID__NAME, oldName, name));
                }
            }
        }
        return name;
    ...
    public void setName(NamedElement newName) {
        ...
        name = newName;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.NESTED_DOT_ID__NAME,
                    oldName, name));
        }
    }
    ...
    public NotificationChain basicSetSubName(NestedDotID newSubName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.NESTED_DOT_ID__SUB_NAME, oldSubName, newSubName);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setSubName(NestedDotID newSubName) {
        if (newSubName != subName) {
            ...
            if (subName != null) {
                msgs = ((InternalEObject) subName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.NESTED_DOT_ID__SUB_NAME, null, msgs);
            }
            if (newSubName != null) {
                msgs = ((InternalEObject) newSubName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.NESTED_DOT_ID__SUB_NAME, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.NESTED_DOT_ID__SUB_NAME, newSubName, newSubName));
        }
    }
