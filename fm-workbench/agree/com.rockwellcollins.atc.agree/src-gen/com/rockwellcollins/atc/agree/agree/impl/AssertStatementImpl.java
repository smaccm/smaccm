...
public class AssertStatementImpl extends SpecStatementImpl implements AssertStatement {
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.ASSERT_STATEMENT__EXPR, oldExpr, newExpr);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.ASSERT_STATEMENT__EXPR, null, msgs);
			}
			if (newExpr != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.ASSERT_STATEMENT__EXPR, newExpr,
					newExpr));
		}
	}
	...
	public NotificationChain basicSetPattern(PatternStatement newPattern, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AgreePackage.ASSERT_STATEMENT__PATTERN, oldPattern, newPattern);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newPattern != pattern) {
			...
			if (pattern != null) {
				msgs = ((InternalEObject) pattern).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.ASSERT_STATEMENT__PATTERN, null, msgs);
			}
			if (newPattern != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.ASSERT_STATEMENT__PATTERN, newPattern,
					newPattern));
		}
	}
