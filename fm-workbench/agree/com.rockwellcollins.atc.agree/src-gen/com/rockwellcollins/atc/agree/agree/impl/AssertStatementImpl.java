 ...
 * <em><b>Assert Statement</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.AssertStatementImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 * </p>
 * 
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.ASSERT_STATEMENT__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.ASSERT_STATEMENT__EXPR, newExpr, newExpr));
        }
    }
