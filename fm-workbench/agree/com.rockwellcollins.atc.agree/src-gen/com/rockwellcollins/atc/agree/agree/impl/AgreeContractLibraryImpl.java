		...
		if (newContract != contract) {
			...
			if (contract != null) {
				msgs = ((InternalEObject) contract).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.AGREE_CONTRACT_LIBRARY__CONTRACT, null, msgs);
			}
			if (newContract != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.AGREE_CONTRACT_LIBRARY__CONTRACT,
