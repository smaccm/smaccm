 ...
 * <em><b>Contract Library</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.AgreeContractLibraryImpl#getContract
 * <em>Contract</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetContract(Contract newContract, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.AGREE_CONTRACT_LIBRARY__CONTRACT, oldContract, newContract);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newContract != contract) {
            ...
            if (contract != null) {
                msgs = ((InternalEObject) contract).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.AGREE_CONTRACT_LIBRARY__CONTRACT, null, msgs);
            }
            if (newContract != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.AGREE_CONTRACT_LIBRARY__CONTRACT, newContract, newContract));
        }
    }
