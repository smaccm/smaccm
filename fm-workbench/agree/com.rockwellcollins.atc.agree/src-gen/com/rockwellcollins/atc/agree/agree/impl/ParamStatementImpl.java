 ...
 * <em><b>Param Statement</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.ParamStatementImpl#getExpr
 * <em>Expr</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.ParamStatementImpl#getType
 * <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ParamStatementImpl extends SpecStatementImpl implements ParamStatement {
    ...
    public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PARAM_STATEMENT__EXPR, oldExpr, newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PARAM_STATEMENT__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PARAM_STATEMENT__EXPR, newExpr, newExpr));
        }
    }
    ...
    public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PARAM_STATEMENT__TYPE, oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.PARAM_STATEMENT__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.PARAM_STATEMENT__TYPE, newType, newType));
        }
    }
