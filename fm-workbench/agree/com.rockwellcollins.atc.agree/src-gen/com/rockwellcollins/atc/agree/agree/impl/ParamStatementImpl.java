		...
		if (newExpr != expr) {
			...
			if (expr != null) {
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.PARAM_STATEMENT__EXPR, null, msgs);
			}
			if (newExpr != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PARAM_STATEMENT__EXPR, newExpr,
					newExpr));
		}
	}
		...
		if (newType != type) {
			...
			if (type != null) {
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.PARAM_STATEMENT__TYPE, null, msgs);
			}
			if (newType != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.PARAM_STATEMENT__TYPE, newType,
					newType));
		}
	}
