...
public class NodeDefExprImpl extends NamedElementImpl implements NodeDefExpr {
	...
	public EList<Arg> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<>(Arg.class, this, AgreePackage.NODE_DEF_EXPR__ARGS);
		}
		return args;
	}
	...
	public EList<Arg> getRets() {
		if (rets == null) {
			rets = new EObjectContainmentEList<>(Arg.class, this, AgreePackage.NODE_DEF_EXPR__RETS);
		}
		return rets;
	}
	...
	public void setNodeBody(NodeBodyExpr newNodeBody) {
		if (newNodeBody != nodeBody) {
			...
			if (nodeBody != null) {
				msgs = ((InternalEObject) nodeBody).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
			}
			if (newNodeBody != null) {
				msgs = ((InternalEObject) newNodeBody).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.NODE_DEF_EXPR__NODE_BODY, newNodeBody,
					newNodeBody));
		}
	}
