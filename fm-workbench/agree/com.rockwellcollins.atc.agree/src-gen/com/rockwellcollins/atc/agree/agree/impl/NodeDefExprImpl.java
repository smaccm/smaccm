...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Node Def Expr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NodeDefExprImpl extends NamedElementImpl implements NodeDefExpr
{
  ...
  public EList<Arg> getRets()
  {
    if (rets == null)
    {
      rets = new EObjectContainmentEList<Arg>(Arg.class, this, AgreePackage.NODE_DEF_EXPR__RETS);
    }
    return rets;
  }
  ...
  public NotificationChain basicSetNodeBody(NodeBodyExpr newNodeBody, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgreePackage.NODE_DEF_EXPR__NODE_BODY, oldNodeBody, newNodeBody);
  ...
  public void setNodeBody(NodeBodyExpr newNodeBody)
  {
    if (newNodeBody != nodeBody)
    {
      ...
      if (nodeBody != null)
        msgs = ((InternalEObject)nodeBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
      if (newNodeBody != null)
        msgs = ((InternalEObject)newNodeBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
      msgs = basicSetNodeBody(newNodeBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgreePackage.NODE_DEF_EXPR__NODE_BODY, newNodeBody, newNodeBody));
  }
