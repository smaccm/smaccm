 ...
 * <em><b>Node Def Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.NodeDefExprImpl#getArgs
 * <em>Args</em>}</li>
 * <li>{@link com.rockwellcollins.atc.agree.agree.impl.NodeDefExprImpl#getRets
 * <em>Rets</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.agree.agree.impl.NodeDefExprImpl#getNodeBody
 * <em>Node Body</em>}</li>
 * </ul>
 * </p>
 * 
...
public class NodeDefExprImpl extends NamedElementImpl implements NodeDefExpr {
    ...
    /**
     * The cached value of the '{@link #getRets() <em>Rets</em>}' containment
     * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRets()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getNodeBody() <em>Node Body</em>}'
    ...
    protected EClass eStaticClass() {
        return AgreePackage.Literals.NODE_DEF_EXPR;
    }
    ...
    public EList<Arg> getArgs() {
        if (args == null) {
            args = new EObjectContainmentEList<Arg>(Arg.class, this,
                    AgreePackage.NODE_DEF_EXPR__ARGS);
        }
        return args;
    }
    ...
    public EList<Arg> getRets() {
        if (rets == null) {
            rets = new EObjectContainmentEList<Arg>(Arg.class, this,
                    AgreePackage.NODE_DEF_EXPR__RETS);
        }
        return rets;
    }
    ...
    public NotificationChain basicSetNodeBody(NodeBodyExpr newNodeBody, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    AgreePackage.NODE_DEF_EXPR__NODE_BODY, oldNodeBody, newNodeBody);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setNodeBody(NodeBodyExpr newNodeBody) {
        if (newNodeBody != nodeBody) {
            ...
            if (nodeBody != null) {
                msgs = ((InternalEObject) nodeBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
            }
            if (newNodeBody != null) {
                msgs = ((InternalEObject) newNodeBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - AgreePackage.NODE_DEF_EXPR__NODE_BODY, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AgreePackage.NODE_DEF_EXPR__NODE_BODY, newNodeBody, newNodeBody));
        }
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
        ...
        case AgreePackage.NODE_DEF_EXPR__RETS:
