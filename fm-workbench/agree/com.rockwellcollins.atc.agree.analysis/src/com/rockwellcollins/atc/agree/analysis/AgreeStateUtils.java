...
public class AgreeStateUtils {
	...
	public static void addToRefMap(String refString, EObject reference, AgreeRenaming agreeRename,
			...
			if (type.id.equals(typeStr)) {
				...
				for (Entry<String, Type> field : type.fields.entrySet()) {
					...
					if (!(fieldType instanceof NamedType) && !(fieldType instanceof RecordType)) {
						throw new AgreeException("Unhandled type: '" + fieldType.getClass().getName() + "'");
					}
