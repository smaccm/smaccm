		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getChainIDAccess().getGroup(), "rule__ChainID__Group__0");
					put(grammarAccess.getChainIDAccess().getGroup_0(), "rule__ChainID__Group_0__0");
					put(grammarAccess.getChainIDAccess().getGroup_1(), "rule__ChainID__Group_1__0");
					put(grammarAccess.getChainIDAccess().getGroup_1_0(), "rule__ChainID__Group_1_0__0");
					...
					put(grammarAccess.getNestedDotIDAccess().getChainIDAssignment_0(), "rule__NestedDotID__ChainIDAssignment_0");
					put(grammarAccess.getNestedDotIDAccess().getTagAssignment_1_0_1(), "rule__NestedDotID__TagAssignment_1_0_1");
					put(grammarAccess.getChainIDAccess().getNamedElmAssignment_0_1(), "rule__ChainID__NamedElmAssignment_0_1");
					put(grammarAccess.getChainIDAccess().getNamedElmAssignment_1_0_2(), "rule__ChainID__NamedElmAssignment_1_0_2");
