		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAccess().getStringAlternatives_0_1_0(), "rule__Type__StringAlternatives_0_1_0");
					...
					put(grammarAccess.getNestedDotIDAccess().getAlternatives_1_1(), "rule__NestedDotID__Alternatives_1_1");
					...
					put(grammarAccess.getTypeDefExprAccess().getGroup(), "rule__TypeDefExpr__Group__0");
					put(grammarAccess.getTypeDefExprAccess().getGroup_6(), "rule__TypeDefExpr__Group_6__0");
					put(grammarAccess.getTypeDefExprAccess().getGroup_6_1(), "rule__TypeDefExpr__Group_6_1__0");
					...
					put(grammarAccess.getTermExprAccess().getGroup_1_1_2(), "rule__TermExpr__Group_1_1_2__0");
					put(grammarAccess.getTermExprAccess().getGroup_1_1_2_1(), "rule__TermExpr__Group_1_1_2_1__0");
					...
					put(grammarAccess.getTermExprAccess().getGroup_7_3(), "rule__TermExpr__Group_7_3__0");
					put(grammarAccess.getTermExprAccess().getGroup_7_3_3(), "rule__TermExpr__Group_7_3_3__0");
					put(grammarAccess.getTermExprAccess().getGroup_8(), "rule__TermExpr__Group_8__0");
					put(grammarAccess.getTermExprAccess().getGroup_8_1(), "rule__TermExpr__Group_8_1__0");
					put(grammarAccess.getTermExprAccess().getGroup_8_1_0(), "rule__TermExpr__Group_8_1_0__0");
					...
					put(grammarAccess.getTypeAccess().getFeatureGroupAssignment_1_1_0(), "rule__Type__FeatureGroupAssignment_1_1_0");
					put(grammarAccess.getTypeAccess().getRecordAssignment_1_1_1(), "rule__Type__RecordAssignment_1_1_1");
					put(grammarAccess.getTypeDefExprAccess().getNameAssignment_2(), "rule__TypeDefExpr__NameAssignment_2");
					put(grammarAccess.getTypeDefExprAccess().getArgsAssignment_6_0(), "rule__TypeDefExpr__ArgsAssignment_6_0");
					put(grammarAccess.getTypeDefExprAccess().getArgsAssignment_6_1_1(), "rule__TypeDefExpr__ArgsAssignment_6_1_1");
					...
					put(grammarAccess.getTermExprAccess().getArgsAssignment_1_1_2_0(), "rule__TermExpr__ArgsAssignment_1_1_2_0");
					put(grammarAccess.getTermExprAccess().getArgsAssignment_1_1_2_1_1(), "rule__TermExpr__ArgsAssignment_1_1_2_1_1");
					...
					put(grammarAccess.getTermExprAccess().getRecordAssignment_7_1(), "rule__TermExpr__RecordAssignment_7_1");
					put(grammarAccess.getTermExprAccess().getArgsAssignment_7_3_0(), "rule__TermExpr__ArgsAssignment_7_3_0");
					put(grammarAccess.getTermExprAccess().getArgExprAssignment_7_3_2(), "rule__TermExpr__ArgExprAssignment_7_3_2");
					put(grammarAccess.getTermExprAccess().getArgsAssignment_7_3_3_1(), "rule__TermExpr__ArgsAssignment_7_3_3_1");
					put(grammarAccess.getTermExprAccess().getArgExprAssignment_7_3_3_3(), "rule__TermExpr__ArgExprAssignment_7_3_3_3");
					put(grammarAccess.getTermExprAccess().getArgsAssignment_8_1_0_1(), "rule__TermExpr__ArgsAssignment_8_1_0_1");
					put(grammarAccess.getTermExprAccess().getArgExprAssignment_8_1_0_3(), "rule__TermExpr__ArgExprAssignment_8_1_0_3");
					put(grammarAccess.getNestedDotIDAccess().getBaseAssignment_0(), "rule__NestedDotID__BaseAssignment_0");
					put(grammarAccess.getNestedDotIDAccess().getTagAssignment_1_1_0(), "rule__NestedDotID__TagAssignment_1_1_0");
					put(grammarAccess.getNestedDotIDAccess().getSubAssignment_1_1_1(), "rule__NestedDotID__SubAssignment_1_1_1");
