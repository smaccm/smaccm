		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWheneverStatementAccess().getAlternatives_0_0_0_5(), "rule__WheneverStatement__Alternatives_0_0_0_5");
					put(grammarAccess.getWheneverStatementAccess().getAlternatives_1_0_0_6(), "rule__WheneverStatement__Alternatives_1_0_0_6");
					...
					put(grammarAccess.getWheneverStatementAccess().getGroup_0_2(), "rule__WheneverStatement__Group_0_2__0");
					...
					put(grammarAccess.getWheneverStatementAccess().getGroup_1_2(), "rule__WheneverStatement__Group_1_2__0");
					...
					put(grammarAccess.getWheneverStatementAccess().getGroup_2_2(), "rule__WheneverStatement__Group_2_2__0");
					...
					put(grammarAccess.getTermExprAccess().getGroup_7_2(), "rule__TermExpr__Group_7_2__0");
					...
					put(grammarAccess.getWhenStatementAccess().getExclAssignment_0_1(), "rule__WhenStatement__ExclAssignment_0_1");
					put(grammarAccess.getWhenStatementAccess().getConditionIntervalAssignment_0_3(), "rule__WhenStatement__ConditionIntervalAssignment_0_3");
					put(grammarAccess.getWhenStatementAccess().getEventAssignment_0_4(), "rule__WhenStatement__EventAssignment_0_4");
					...
					put(grammarAccess.getWhenStatementAccess().getExclAssignment_1_1(), "rule__WhenStatement__ExclAssignment_1_1");
					put(grammarAccess.getWhenStatementAccess().getTimesAssignment_1_2(), "rule__WhenStatement__TimesAssignment_1_2");
					put(grammarAccess.getWhenStatementAccess().getIntervalAssignment_1_5(), "rule__WhenStatement__IntervalAssignment_1_5");
					...
					put(grammarAccess.getWheneverStatementAccess().getExclAssignment_0_1(), "rule__WheneverStatement__ExclAssignment_0_1");
					put(grammarAccess.getWheneverStatementAccess().getIntervalAssignment_0_2_1(), "rule__WheneverStatement__IntervalAssignment_0_2_1");
					...
					put(grammarAccess.getWheneverStatementAccess().getExclAssignment_1_1(), "rule__WheneverStatement__ExclAssignment_1_1");
					put(grammarAccess.getWheneverStatementAccess().getIntervalAssignment_1_2_1(), "rule__WheneverStatement__IntervalAssignment_1_2_1");
					...
					put(grammarAccess.getWheneverStatementAccess().getExclAssignment_2_1(), "rule__WheneverStatement__ExclAssignment_2_1");
					put(grammarAccess.getWheneverStatementAccess().getIntervalAssignment_2_2_1(), "rule__WheneverStatement__IntervalAssignment_2_2_1");
					...
					put(grammarAccess.getTermExprAccess().getValAssignment_6_1(), "rule__TermExpr__ValAssignment_6_1");
					put(grammarAccess.getTermExprAccess().getSubThisAssignment_7_2_1(), "rule__TermExpr__SubThisAssignment_7_2_1");
					put(grammarAccess.getTermExprAccess().getExprAssignment_8_3(), "rule__TermExpr__ExprAssignment_8_3");
					put(grammarAccess.getTermExprAccess().getExprAssignment_9_3(), "rule__TermExpr__ExprAssignment_9_3");
