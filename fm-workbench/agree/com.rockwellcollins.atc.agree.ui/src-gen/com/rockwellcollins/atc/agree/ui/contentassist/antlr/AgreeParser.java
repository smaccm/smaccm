		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTermExprAccess().getOpAlternatives_2_1_0(), "rule__TermExpr__OpAlternatives_2_1_0");
					put(grammarAccess.getTermExprAccess().getOpAlternatives_3_1_0(), "rule__TermExpr__OpAlternatives_3_1_0");
					...
					put(grammarAccess.getTermExprAccess().getGroup_13_2(), "rule__TermExpr__Group_13_2__0");
					...
					put(grammarAccess.getTermExprAccess().getOpAssignment_2_1(), "rule__TermExpr__OpAssignment_2_1");
					put(grammarAccess.getTermExprAccess().getLeftAssignment_2_3(), "rule__TermExpr__LeftAssignment_2_3");
					put(grammarAccess.getTermExprAccess().getRightAssignment_2_5(), "rule__TermExpr__RightAssignment_2_5");
					put(grammarAccess.getTermExprAccess().getOpAssignment_3_1(), "rule__TermExpr__OpAssignment_3_1");
					...
					put(grammarAccess.getTermExprAccess().getIdAssignment_10_3(), "rule__TermExpr__IdAssignment_10_3");
					put(grammarAccess.getTermExprAccess().getValAssignment_11_1(), "rule__TermExpr__ValAssignment_11_1");
					put(grammarAccess.getTermExprAccess().getValAssignment_12_1(), "rule__TermExpr__ValAssignment_12_1");
					put(grammarAccess.getTermExprAccess().getSubThisAssignment_13_2_1(), "rule__TermExpr__SubThisAssignment_13_2_1");
					put(grammarAccess.getTermExprAccess().getExprAssignment_14_3(), "rule__TermExpr__ExprAssignment_14_3");
					put(grammarAccess.getTermExprAccess().getExprAssignment_15_3(), "rule__TermExpr__ExprAssignment_15_3");
