		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSpecStatementAccess().getAlternatives_0_5(), "rule__SpecStatement__Alternatives_0_5");
					put(grammarAccess.getSpecStatementAccess().getAlternatives_1_5(), "rule__SpecStatement__Alternatives_1_5");
					put(grammarAccess.getSpecStatementAccess().getAlternatives_2_3(), "rule__SpecStatement__Alternatives_2_3");
					put(grammarAccess.getSpecStatementAccess().getAlternatives_3_5(), "rule__SpecStatement__Alternatives_3_5");
					...
					put(grammarAccess.getTermExprAccess().getGroup_11_2(), "rule__TermExpr__Group_11_2__0");
					...
					put(grammarAccess.getSpecStatementAccess().getNameAssignment_0_2(), "rule__SpecStatement__NameAssignment_0_2");
					put(grammarAccess.getSpecStatementAccess().getStrAssignment_0_3(), "rule__SpecStatement__StrAssignment_0_3");
					put(grammarAccess.getSpecStatementAccess().getExprAssignment_0_5_0(), "rule__SpecStatement__ExprAssignment_0_5_0");
					put(grammarAccess.getSpecStatementAccess().getPatternAssignment_0_5_1(), "rule__SpecStatement__PatternAssignment_0_5_1");
					put(grammarAccess.getSpecStatementAccess().getNameAssignment_1_2(), "rule__SpecStatement__NameAssignment_1_2");
					put(grammarAccess.getSpecStatementAccess().getStrAssignment_1_3(), "rule__SpecStatement__StrAssignment_1_3");
					put(grammarAccess.getSpecStatementAccess().getExprAssignment_1_5_0(), "rule__SpecStatement__ExprAssignment_1_5_0");
					put(grammarAccess.getSpecStatementAccess().getPatternAssignment_1_5_1(), "rule__SpecStatement__PatternAssignment_1_5_1");
					put(grammarAccess.getSpecStatementAccess().getNameAssignment_2_2_0(), "rule__SpecStatement__NameAssignment_2_2_0");
					put(grammarAccess.getSpecStatementAccess().getStrAssignment_2_2_1(), "rule__SpecStatement__StrAssignment_2_2_1");
					...
					put(grammarAccess.getSpecStatementAccess().getNameAssignment_3_2(), "rule__SpecStatement__NameAssignment_3_2");
					put(grammarAccess.getSpecStatementAccess().getStrAssignment_3_3(), "rule__SpecStatement__StrAssignment_3_3");
					put(grammarAccess.getSpecStatementAccess().getExprAssignment_3_5_0(), "rule__SpecStatement__ExprAssignment_3_5_0");
					put(grammarAccess.getSpecStatementAccess().getPatternAssignment_3_5_1(), "rule__SpecStatement__PatternAssignment_3_5_1");
					put(grammarAccess.getSpecStatementAccess().getExprAssignment_4_3(), "rule__SpecStatement__ExprAssignment_4_3");
					put(grammarAccess.getSpecStatementAccess().getExprAssignment_5_2(), "rule__SpecStatement__ExprAssignment_5_2");
					put(grammarAccess.getSpecStatementAccess().getTypeAssignment_5_4(), "rule__SpecStatement__TypeAssignment_5_4");
