		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRecordUpdateExprsAccess().getGroup(), "rule__RecordUpdateExprs__Group__0");
					put(grammarAccess.getRecordUpdateExprsAccess().getGroup_1(), "rule__RecordUpdateExprs__Group_1__0");
					put(grammarAccess.getRecordUpdateExprsAccess().getGroup_1_0(), "rule__RecordUpdateExprs__Group_1_0__0");
					put(grammarAccess.getRecordUpdateExprsAccess().getGroup_1_0_1(), "rule__RecordUpdateExprs__Group_1_0_1__0");
					...
					put(grammarAccess.getComplexExprAccess().getGroup_1_1_4(), "rule__ComplexExpr__Group_1_1_4__0");
					...
					put(grammarAccess.getRecordUpdateExprsAccess().getArgsAssignment_1_0_1_1(), "rule__RecordUpdateExprs__ArgsAssignment_1_0_1_1");
					put(grammarAccess.getRecordUpdateExprsAccess().getArgExprAssignment_1_0_1_3(), "rule__RecordUpdateExprs__ArgExprAssignment_1_0_1_3");
					...
					put(grammarAccess.getComplexExprAccess().getArgsAssignment_1_1_1(), "rule__ComplexExpr__ArgsAssignment_1_1_1");
					put(grammarAccess.getComplexExprAccess().getArgExprAssignment_1_1_3(), "rule__ComplexExpr__ArgExprAssignment_1_1_3");
					put(grammarAccess.getComplexExprAccess().getArgsAssignment_1_1_4_1(), "rule__ComplexExpr__ArgsAssignment_1_1_4_1");
					put(grammarAccess.getComplexExprAccess().getArgExprAssignment_1_1_4_3(), "rule__ComplexExpr__ArgExprAssignment_1_1_4_3");
