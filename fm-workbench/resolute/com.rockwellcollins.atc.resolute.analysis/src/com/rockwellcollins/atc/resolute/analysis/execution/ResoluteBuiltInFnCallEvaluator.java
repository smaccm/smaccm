    ...
    public ResoluteValue evaluate(BuiltInFnCallExpr fnCallExpr, List<ResoluteValue> args) {
        ...
        case "parent": {
            ...
            if (parent instanceof NamedElement) {
                ...
                throw new ResoluteFailException("Unable to get parent of " + args.get(0),
                        fnCallExpr);
            }
        }
        ...
        case "features": {
            ...
            if (e instanceof ComponentInstance) {
                ...
                throw new ResoluteFailException("features not defined on object of type: "
                        + args.get(0).getType(), fnCallExpr);
            }
        }
        ...
        case "connections": {
            ...
            if (e instanceof FeatureInstance) {
                ...
                throw new ResoluteFailException("connections not defined on object of type: "
                        + args.get(0).getType(), fnCallExpr);
            }
        }
        ...
        case "analysis": {
            ...
            ResoluteValue value = EvaluateExternalAnalysis.evaluate(analysisName, context,
                    analysisArgs);
                ...
                if (isInstanceOf(ci, decl)) {
                    if (result == null) {
                        ...
                        throw new ResoluteFailException(
                                "Found multiple instances of declarative element", fnCallExpr);
                    }
                }
            }
            if (result != null) {
