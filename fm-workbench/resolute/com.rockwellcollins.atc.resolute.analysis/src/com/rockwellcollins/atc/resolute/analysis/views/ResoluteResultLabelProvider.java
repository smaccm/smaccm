...
public class ResoluteResultLabelProvider implements ILabelProvider {
    ...
    private static Image loadImage(String filename) {
        try (InputStream stream = ResoluteResultLabelProvider.class.getResourceAsStream(filename)) {
