 ...
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.UnaryExprImpl#getOp
 * <em>Op</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.UnaryExprImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 * </p>
 * 
...
public class UnaryExprImpl extends ExprImpl implements UnaryExpr {
    ...
    public void setOp(String newOp) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.UNARY_EXPR__OP,
                    oldOp, op));
        }
    }
    ...
    public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.UNARY_EXPR__EXPR, oldExpr, newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.UNARY_EXPR__EXPR, null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.UNARY_EXPR__EXPR,
                    newExpr, newExpr));
        }
    }
