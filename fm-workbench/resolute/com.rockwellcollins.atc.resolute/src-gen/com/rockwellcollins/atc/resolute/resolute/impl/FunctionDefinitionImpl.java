 ...
 * <em><b>Function Definition</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.FunctionDefinitionImpl#getArgs
 * <em>Args</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.FunctionDefinitionImpl#getBody
 * <em>Body</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public EList<Arg> getArgs() {
        if (args == null) {
            args = new EObjectContainmentEList<Arg>(Arg.class, this,
                    ResolutePackage.FUNCTION_DEFINITION__ARGS);
        }
        return args;
    }
    ...
    public NotificationChain basicSetBody(DefinitionBody newBody, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.FUNCTION_DEFINITION__BODY, oldBody, newBody);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newBody != body) {
            ...
            if (body != null) {
                msgs = ((InternalEObject) body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.FUNCTION_DEFINITION__BODY, null, msgs);
            }
            if (newBody != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.FUNCTION_DEFINITION__BODY, newBody, newBody));
        }
    }
