 ...
 * <em><b>Func Body</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.FuncBodyImpl#getType
 * <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.FUNC_BODY__TYPE, oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.FUNC_BODY__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.FUNC_BODY__TYPE,
                    newType, newType));
        }
    }
