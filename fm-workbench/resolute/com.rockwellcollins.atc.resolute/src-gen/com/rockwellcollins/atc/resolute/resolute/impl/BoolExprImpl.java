 ...
 * <em><b>Bool Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.BoolExprImpl#getVal
 * <em>Val</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetVal(BooleanLiteral newVal, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.BOOL_EXPR__VAL, oldVal, newVal);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newVal != val) {
            ...
            if (val != null) {
                msgs = ((InternalEObject) val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.BOOL_EXPR__VAL, null, msgs);
            }
            if (newVal != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.BOOL_EXPR__VAL,
                    newVal, newVal));
        }
    }
