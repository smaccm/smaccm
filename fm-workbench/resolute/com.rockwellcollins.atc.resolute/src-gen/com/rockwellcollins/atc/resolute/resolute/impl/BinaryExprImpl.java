 ...
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.BinaryExprImpl#getLeft
 * <em>Left</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.BinaryExprImpl#getOp
 * <em>Op</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.BinaryExprImpl#getRight
 * <em>Right</em>}</li>
 * </ul>
 * </p>
 * 
...
public class BinaryExprImpl extends ExprImpl implements BinaryExpr {
    ...
    public NotificationChain basicSetLeft(Expr newLeft, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.BINARY_EXPR__LEFT, oldLeft, newLeft);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newLeft != left) {
            ...
            if (left != null) {
                msgs = ((InternalEObject) left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.BINARY_EXPR__LEFT, null, msgs);
            }
            if (newLeft != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.BINARY_EXPR__LEFT, newLeft, newLeft));
        }
    }
    ...
    public void setOp(String newOp) {
        ...
        op = newOp;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.BINARY_EXPR__OP,
                    oldOp, op));
        }
    }
    ...
    public NotificationChain basicSetRight(Expr newRight, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.BINARY_EXPR__RIGHT, oldRight, newRight);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newRight != right) {
            ...
            if (right != null) {
                msgs = ((InternalEObject) right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.BINARY_EXPR__RIGHT, null, msgs);
            }
            if (newRight != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.BINARY_EXPR__RIGHT, newRight, newRight));
        }
    }
