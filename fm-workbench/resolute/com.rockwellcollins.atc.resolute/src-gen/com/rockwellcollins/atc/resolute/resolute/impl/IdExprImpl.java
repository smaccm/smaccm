 ...
 * <ul>
 * <li>{@link com.rockwellcollins.atc.resolute.resolute.impl.IdExprImpl#getId
 * <em>Id</em>}</li>
 * </ul>
 * </p>
 * 
...
public class IdExprImpl extends ExprImpl implements IdExpr {
            ...
            if (id != oldId) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ResolutePackage.ID_EXPR__ID, oldId, id));
                }
            }
        }
        return id;
    ...
    public void setId(NamedElement newId) {
        ...
        id = newId;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.ID_EXPR__ID,
                    oldId, id));
        }
    }
