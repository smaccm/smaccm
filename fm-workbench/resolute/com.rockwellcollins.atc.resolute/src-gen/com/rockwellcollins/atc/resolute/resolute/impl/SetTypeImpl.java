 ...
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.SetTypeImpl#getType
 * <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
    ...
    public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ResolutePackage.SET_TYPE__TYPE, oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResolutePackage.SET_TYPE__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.SET_TYPE__TYPE,
                    newType, newType));
        }
    }
