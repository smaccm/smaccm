...
public class ResoluteSemanticSequencer extends PropertiesSemanticSequencer {
    ...
    public void createSequence(EObject context, EObject semanticObject) {
        if (semanticObject.eClass().getEPackage() == Aadl2Package.eINSTANCE) {
        ...
        } else if (semanticObject.eClass().getEPackage() == ResolutePackage.eINSTANCE) {
            switch (semanticObject.eClass().getClassifierID()) {
            ...
            case ResolutePackage.BINARY_EXPR:
                if (context == grammarAccess.getAndExprRule()
                        ...
                        || context == grammarAccess.getPlusExprAccess()
                                .getBinaryExprLeftAction_1_0_0_0()
                        || context == grammarAccess.getPrefixExprRule()
                        || context == grammarAccess.getRelationalExprRule()
                        || context == grammarAccess.getRelationalExprAccess()
                                .getBinaryExprLeftAction_1_0_0_0()
                        || context == grammarAccess.getSetOpExprRule()
                        || context == grammarAccess.getSetOpExprAccess()
                                .getBinaryExprLeftAction_1_0_0_0()
                        || context == grammarAccess.getTimesExprRule()
                        || context == grammarAccess.getTimesExprAccess()
                                .getBinaryExprLeftAction_1_0_0_0()) {
                    sequence_AndExpr_ImpliesExpr_OrExpr_PlusExpr_RelationalExpr_SetOpExpr_TimesExpr(
    ...
    /**
     * Constraint: ( (left=TimesExpr_BinaryExpr_1_0_0_0 (op='*' | op='/')
     * right=SetOpExpr) | (left=SetOpExpr_BinaryExpr_1_0_0_0 (op='union' |
     * op='intersect') right=PrefixExpr) | (left=PlusExpr_BinaryExpr_1_0_0_0
     * (op='+' | op='-') right=TimesExpr) |
     ...
     */
    protected void sequence_AndExpr_ImpliesExpr_OrExpr_PlusExpr_RelationalExpr_SetOpExpr_TimesExpr(
    ...
    /**
     * Constraint: (fn=BuiltInFunc (args+=Expr args+=Expr*)?)
     */
    ...
    /**
     * Constraint: (map=Expr args+=Arg+ filter=Expr?)
     */
    ...
    /**
     * Constraint: (fn=[FunctionDefinition|ID] (args+=Expr args+=Expr*)?)
     */
    ...
    /**
     * Constraint: id=[NamedElement|QCREF]
     */
    ...
    /**
     * Constraint: (cond=Expr then=Expr else=Expr)
     */
    ...
    /**
     * Constraint: ((quant='forall' | quant='exists') args+=Arg+ expr=Expr)
     */
    ...
    /**
     * Constraint: ( name='data' | name='thread' | name='thread_group' |
     * name='process' | name='subprogram' | name='subprogram_group' |
     * name='processor' | name='virtual_processor' | name='memory' | name='bus'
     * | name='virtual_bus' | name='device' | name='system' | name='abstract' |
     * name='connection' | name='component' | name='string' | name='int' |
     * name='real' | name='bool' )
     */
    ...
    /**
     * Constraint: (claim+=ClaimString* expr=Expr)
     */
    ...
    /**
     * Constraint: (type=Type expr=Expr)
     */
    ...
    /**
     * Constraint: (name=ID (args+=Arg args+=Arg*)? body=DefinitionBody)
     */
    ...
    /**
     * Constraint: (value=UnsignedInt unit=[UnitLiteral|ID]?)
     */
    ...
    /**
     * Constraint: ((op='-' | op='not') expr=PrefixExpr)
     */
    ...
    /**
     * Constraint: (value=UnsignedReal unit=[UnitLiteral|ID]?)
     */
    ...
    /**
     * Constraint: (definitions+=Definition*)
     */
    ...
    /**
     * Constraint: (proves+=ProveStatement*)
     */
