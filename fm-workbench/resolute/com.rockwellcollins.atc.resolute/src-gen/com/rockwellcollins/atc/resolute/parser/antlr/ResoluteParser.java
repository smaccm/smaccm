...
public class ResoluteParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
    ...
    @Override
    protected com.rockwellcollins.atc.resolute.parser.antlr.internal.InternalResoluteParser createParser(
            XtextTokenStream stream) {
        return new com.rockwellcollins.atc.resolute.parser.antlr.internal.InternalResoluteParser(
