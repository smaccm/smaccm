 ...
 * <ul>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.FnCallExprImpl#getFn
 * <em>Fn</em>}</li>
 * <li>
 * {@link com.rockwellcollins.atc.resolute.resolute.impl.FnCallExprImpl#getArgs
 * <em>Args</em>}</li>
 * </ul>
 * </p>
 * 
...
public class FnCallExprImpl extends ExprImpl implements FnCallExpr {
            ...
            if (fn != oldFn) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ResolutePackage.FN_CALL_EXPR__FN, oldFn, fn));
                }
            }
        }
        return fn;
    ...
    public void setFn(FunctionDefinition newFn) {
        ...
        fn = newFn;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ResolutePackage.FN_CALL_EXPR__FN,
                    oldFn, fn));
        }
    }
    ...
    public EList<Expr> getArgs() {
        if (args == null) {
            args = new EObjectContainmentEList<Expr>(Expr.class, this,
                    ResolutePackage.FN_CALL_EXPR__ARGS);
        }
        return args;
    }
