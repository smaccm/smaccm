...
Agree_property_description : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('Y'|'y')'_'('D'|'d')('E'|'e')('S'|'s')('C'|'c')('R'|'r')('I'|'i')('P'|'p')('T'|'t')('I'|'i')('O'|'o')('N'|'n');
...
Has_agree_property : ('H'|'h')('A'|'a')('S'|'s')'_'('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('Y'|'y');

Agree_property_id : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('Y'|'y')'_'('I'|'i')('D'|'d');
...
Agree_guarantees : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('G'|'g')('U'|'u')('A'|'a')('R'|'r')('A'|'a')('N'|'n')('T'|'t')('E'|'e')('E'|'e')('S'|'s');

Agree_properties : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('I'|'i')('E'|'e')('S'|'s');
...
Agree_property : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('Y'|'y');
...
Agree_asserts : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('A'|'a')('S'|'s')('S'|'s')('E'|'e')('R'|'r')('T'|'t')('S'|'s');

Agree_assumes : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('A'|'a')('S'|'s')('S'|'s')('U'|'u')('M'|'m')('E'|'e')('S'|'s');
...
Agree_lemmas : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('L'|'l')('E'|'e')('M'|'m')('M'|'m')('A'|'a')('S'|'s');

Has_property : ('H'|'h')('A'|'a')('S'|'s')'_'('P'|'p')('R'|'r')('O'|'o')('P'|'p')('E'|'e')('R'|'r')('T'|'t')('Y'|'y');

Is_data_port : ('I'|'i')('S'|'s')'_'('D'|'d')('A'|'a')('T'|'t')('A'|'a')'_'('P'|'p')('O'|'o')('R'|'r')('T'|'t');

Is_guarantee : ('I'|'i')('S'|'s')'_'('G'|'g')('U'|'u')('A'|'a')('R'|'r')('A'|'a')('N'|'n')('T'|'t')('E'|'e')('E'|'e');
...
Agree_spec : ('A'|'a')('G'|'g')('R'|'r')('E'|'e')('E'|'e')'_'('S'|'s')('P'|'p')('E'|'e')('C'|'c');
...
Is_assert : ('I'|'i')('S'|'s')'_'('A'|'a')('S'|'s')('S'|'s')('E'|'e')('R'|'r')('T'|'t');

Is_assume : ('I'|'i')('S'|'s')'_'('A'|'a')('S'|'s')('S'|'s')('U'|'u')('M'|'m')('E'|'e');
...
Is_lemma : ('I'|'i')('S'|'s')'_'('L'|'l')('E'|'e')('M'|'m')('M'|'m')('A'|'a');
