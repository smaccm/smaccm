...
void callback_encoder_ct_in(const uint8_t n_var0[96U])
{
    ...
    if ((bool) !n_deref0) {
        ...
        const int32_t *n_cse13 = &n_ref5->ivory_string_HXCyphertext_len;
        int32_t n_deref6 = *n_cse13;
        int32_t n_deref7 = *n_cse13;
        
        ASSERTS((bool) (n_deref7 < (int32_t) 195));
        
        uint8_t *n_cse22 = n_ref5->ivory_string_HXCyphertext_data;
        
        n_cse22[n_deref7 % 195] = (uint8_t) 126U;
        
        int32_t *n_cse25 = &n_ref5->ivory_string_HXCyphertext_len;
        
        *n_cse25 = (int32_t) ((int32_t) 1 + n_deref7);
        
        int32_t n_deref8 = *n_cse13;
        
        ASSERTS((bool) (n_deref8 < (int32_t) 195));
        n_cse22[n_deref8 % 195] = (uint8_t) 0U;
        *n_cse25 = (int32_t) ((int32_t) 1 + n_deref8);
