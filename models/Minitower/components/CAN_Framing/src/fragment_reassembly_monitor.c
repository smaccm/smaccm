    ...
    if ((bool) !n_cse8) {
        ...
        if ((bool) (n_cse12 >= (uint32_t) 256U)) {
            ...
            if ((bool) !(bool) ((bool) (n_cse22 == n_deref1) || (bool) (n_cse21 > (uint8_t) 9U))) {
                uint8_t n_deref2 = n_var0->buf_len;
                
                if ((bool) ((bool) !(bool) ((bool) (0 == n_cse21) || (bool) (n_cse21 == n_deref1)) || (bool) (n_deref2 != (uint8_t) 8U))) {
                    ...
                    int32_t n_cse38 = (int32_t) n_deref2;
                    
                    ASSERTS((bool) ((bool) (n_cse38 >= (int32_t) 0) && (bool) (n_cse38 <= (int32_t) 8)));
                    for (int32_t n_ix3 = (int32_t) 0; n_ix3 <= (int32_t) 7; n_ix3++) {
                        if ((bool) (n_ix3 < n_cse38)) {
                            int32_t n_cse49 = (int32_t) (n_cse34 + n_ix3);
                            
                            if ((bool) (n_cse49 < (int32_t) 80)) {
                                uint8_t n_deref4 = n_var0->buf[n_ix3];
                                
                                reassembly_buf_0x100[n_cse49 % 80] = n_deref4;
                            }
                        }
                    }
                    if ((bool) (n_cse21 < (uint8_t) 9U)) {
                        ...
                        callback_output_CAN_framing_write_to_server_2(n_ref6);
                    }
                }
            }
        }
