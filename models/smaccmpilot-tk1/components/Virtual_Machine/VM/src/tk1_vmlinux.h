...
#define INTERRUPT_KEYPAD                53
#define INTERRUPT_USB2                  54
#define INTERRUPT_SATA_CTL              56
#define INTERRUPT_VCP                   58
#define INTERRUPT_APB_DMA_CPU           59
#define INTERRUPT_AHB_DMA_CPU           60
