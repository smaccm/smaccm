...
void mavlink_set_roll_pitch_yaw_thrust_msg_send(const
                                                struct set_roll_pitch_yaw_thrust_msg* n_var0,
                                                uint8_t* n_var1,
                                                uint8_t n_var2[80U])
{
    ...
    mavlinkSendWithWriter(56U, 100U, 18U, n_var1, n_var2);
...
void mavlink_set_roll_pitch_yaw_thrust_unpack(struct set_roll_pitch_yaw_thrust_msg* n_var0,
