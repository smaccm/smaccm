                                              ...
                                              uint8_t n_var2[80U])
{
    ...
    for (int32_t n_ix7 = 0; n_ix7 <= 16; n_ix7++) {
    ...
    mavlinkSendWithWriter(51U, 223U, 17U, n_var1, n_var2);
    for (int32_t n_ix9 = 0; n_ix9 <= 54; n_ix9++) {
        ASSERTS(n_ix9 > 0 && 2147483647 - n_ix9 >= 25 || n_ix9 <= 0);
        ASSERTS(0 <= n_ix9 + 25 && n_ix9 + 25 < 80);
        *&n_var2[(n_ix9 + 25) % 80] = 0U;
    }
    return;
}
