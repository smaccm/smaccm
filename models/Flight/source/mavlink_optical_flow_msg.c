                                   ...
                                   uint8_t* n_var1, uint8_t n_var2[80U])
{
    ...
    mavlink_pack_int16_t((uint8_t*) n_ref1, 20U, n_deref6);
    
    int16_t n_deref7 = n_var0->flow_y;
    
    mavlink_pack_int16_t((uint8_t*) n_ref1, 22U, n_deref7);
    ...
    mavlinkSendWithWriter(100U, 175U, 26U, n_var1, n_var2);
                                 ...
                                 uint8_t* n_var1)
{
    ...
    *&n_var0->ground_distance = n_r3;
    ...
    int16_t n_r4 = mavlink_unpack_int16_t(n_var1, 20U);
    
    *&n_var0->flow_x = n_r4;
    
    int16_t n_r5 = mavlink_unpack_int16_t(n_var1, 22U);
