                           ...
                           uint8_t n_var2[80U])
{
    ...
    mavlink_pack_uint8_t((uint8_t*) n_ref1, 12U, n_deref4);
    
    uint8_t n_deref5 = n_var0->target_component;
    
    mavlink_pack_uint8_t((uint8_t*) n_ref1, 13U, n_deref5);
    ...
    mavlinkSendWithWriter(4U, 237U, 14U, n_var1, n_var2);
...
void mavlink_ping_unpack(struct ping_msg* n_var0, const uint8_t* n_var1)
{
    ...
    *&n_var0->ping_seq = n_r1;
    ...
    uint8_t n_r2 = mavlink_unpack_uint8_t(n_var1, 12U);
    
    *&n_var0->target_system = n_r2;
    
    uint8_t n_r3 = mavlink_unpack_uint8_t(n_var1, 13U);
