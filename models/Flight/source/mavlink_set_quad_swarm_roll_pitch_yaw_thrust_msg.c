                                                           ...
                                                           uint8_t n_var2[80U])
{
    ...
    for (int32_t n_ix16 = 0; n_ix16 <= 33; n_ix16++) {
    ...
    mavlinkSendWithWriter(61U, 240U, 34U, n_var1, n_var2);
    for (int32_t n_ix18 = 0; n_ix18 <= 37; n_ix18++) {
        ASSERTS(n_ix18 > 0 && 2147483647 - n_ix18 >= 42 || n_ix18 <= 0);
        ASSERTS(0 <= n_ix18 + 42 && n_ix18 + 42 < 80);
        *&n_var2[(n_ix18 + 42) % 80] = 0U;
    }
    return;
}
