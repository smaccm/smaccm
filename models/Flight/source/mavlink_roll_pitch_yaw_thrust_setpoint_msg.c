...
void mavlink_roll_pitch_yaw_thrust_setpoint_msg_send(const
                                                     struct roll_pitch_yaw_thrust_setpoint_msg* n_var0,
                                                     uint8_t* n_var1,
                                                     uint8_t n_var2[80U])
{
    ...
    mavlinkSendWithWriter(58U, 239U, 20U, n_var1, n_var2);
...
void mavlink_roll_pitch_yaw_thrust_setpoint_unpack(struct roll_pitch_yaw_thrust_setpoint_msg* n_var0,
