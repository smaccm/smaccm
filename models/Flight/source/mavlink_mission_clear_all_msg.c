...
void mavlink_mission_clear_all_msg_send(const
                                        struct mission_clear_all_msg* n_var0,
                                        uint8_t* n_var1, uint8_t n_var2[80U])
{
    ...
    mavlinkSendWithWriter(45U, 232U, 2U, n_var1, n_var2);
...
void mavlink_mission_clear_all_unpack(struct mission_clear_all_msg* n_var0,
