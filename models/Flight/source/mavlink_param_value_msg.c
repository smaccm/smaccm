                                  ...
                                  uint8_t* n_var1, uint8_t n_var2[80U])
{
    ...
    mavlink_pack_uint8_t((uint8_t*) n_ref1, 24U, n_deref5);
    ...
    for (int32_t n_ix7 = 0; n_ix7 <= 15; n_ix7++) {
        ...
        mavlink_pack_uint8_t((uint8_t*) n_ref1, 8U + (uint8_t) n_ix7, n_deref8);
    }
    ...
    mavlinkSendWithWriter(22U, 220U, 25U, n_var1, n_var2);
                                ...
                                uint8_t* n_var1)
{
    ...
    *&n_var0->param_index = n_r2;
    ...
    uint8_t n_r3 = mavlink_unpack_uint8_t(n_var1, 24U);
    
    *&n_var0->param_type = n_r3;
    for (int32_t n_ix4 = 0; n_ix4 <= 15; n_ix4++) {
        uint8_t n_r5 = mavlink_unpack_uint8_t(n_var1, 8U + (uint8_t) n_ix4);
