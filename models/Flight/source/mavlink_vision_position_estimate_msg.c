...
void mavlink_vision_position_estimate_msg_send(const
                                               struct vision_position_estimate_msg* n_var0,
                                               uint8_t* n_var1,
                                               uint8_t n_var2[80U])
{
    ...
    mavlinkSendWithWriter(102U, 158U, 32U, n_var1, n_var2);
...
void mavlink_vision_position_estimate_unpack(struct vision_position_estimate_msg* n_var0,
