                                                           ...
                                                           uint8_t n_var2[80U])
{
    ...
    float n_deref3 = n_var0->roll_rate;
    
    mavlink_pack_float((uint8_t*) n_ref1, 4U, n_deref3);
    
    float n_deref4 = n_var0->pitch_rate;
    
    mavlink_pack_float((uint8_t*) n_ref1, 8U, n_deref4);
    
    float n_deref5 = n_var0->yaw_rate;
    ...
    mavlinkSendWithWriter(80U, 127U, 20U, n_var1, n_var2);
