...
void mavlink_mission_set_current_msg_send(const
                                          struct mission_set_current_msg* n_var0,
                                          uint8_t* n_var1, uint8_t n_var2[80U])
{
    uint8_t n_local0[4U] = {};
    uint8_t* n_ref1 = n_local0;
    uint16_t n_deref2 = n_var0->mission_set_current_seq;
    ...
    mavlinkSendWithWriter(41U, 28U, 4U, n_var1, n_var2);
...
void mavlink_mission_set_current_unpack(struct mission_set_current_msg* n_var0,
                                        const uint8_t* n_var1)
{
    uint16_t n_r0 = mavlink_unpack_uint16_t(n_var1, 0U);
    
    *&n_var0->mission_set_current_seq = n_r0;
