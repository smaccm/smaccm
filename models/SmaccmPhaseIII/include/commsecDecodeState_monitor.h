...
#endif
#include <gec.h>
#include <smaccm_commsecDecodeState.h>
...
extern bool validkey_2;
extern struct gec_sym_key ctx_dl_2_global_gec_sym_key_dec;
void callback_gec_decode_init (const uint8_t n_var0 [24U]);
void callback_cyphertext_decode (const uint8_t n_var0 [96U]);
void ctx_dl_2_decode_init (const uint8_t n_var0 [24U]);
uint32_t ctx_dl_2_decode_run (const uint8_t n_var0 [96U], uint8_t n_var1 [80U]);
