#ifndef __c2_MON_sl_after_harness_h__
#define __c2_MON_sl_after_harness_h__
...
#ifndef typedef_SFc2_MON_sl_after_harnessInstanceStruct
#define typedef_SFc2_MON_sl_after_harnessInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_MON_sl_after_harness;
...
#endif                                 /*typedef_SFc2_MON_sl_after_harnessInstanceStruct*/
...
extern const mxArray *sf_c2_MON_sl_after_harness_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c2_MON_sl_after_harness_get_check_sum(mxArray *plhs[]);
extern void c2_MON_sl_after_harness_method_dispatcher(SimStruct *S, int_T method,
  void *data);
