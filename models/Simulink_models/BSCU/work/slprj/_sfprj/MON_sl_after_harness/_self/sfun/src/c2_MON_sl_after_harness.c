...
static void initialize_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void initialize_params_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void enable_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void disable_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void set_sim_state_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void sf_gateway_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void mdl_start_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void c2_chartstep_c2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void initSimStructsc2_MON_sl_after_harness
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static boolean_T c2_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_b_pre_r_Agree_Nodes__Latch_0, const char_T
  *c2_identifier, boolean_T *c2_svPtr);
static boolean_T c2_b_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_b_pre_mode_Agree_Nodes__Brake_Mode_0, const
  char_T *c2_identifier, boolean_T *c2_svPtr);
static int32_T c2_d_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T *c2_svPtr);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_f_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static int32_T c2_g_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_arrowFunction(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, boolean_T c2_left, boolean_T
  c2_right);
static boolean_T c2_isequal(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, int32_T c2_varargin_1, int32_T c2_varargin_2);
static int32_T c2_ifFunction(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, boolean_T c2_cond, int32_T c2_ifBranch, int32_T c2_elseBranch);
static int32_T c2_b_arrowFunction(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, int32_T c2_left, int32_T c2_right);
static boolean_T c2_b_ifFunction(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, boolean_T c2_cond, boolean_T c2_ifBranch, boolean_T
  c2_elseBranch);
static boolean_T c2_impliesFunction(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, boolean_T c2_left, boolean_T c2_right);
static boolean_T c2_b_isequal(SFc2_MON_sl_after_harnessInstanceStruct
...
static uint8_T c2_h_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MON_sl_after_harness, const
  char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_MON_sl_after_harnessInstanceStruct
  *chartInstance);
  ...
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MON_sl_after_harness(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_harness = 0U;
}
  ...
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance)
{
  ...
  c2_i_hoistedGlobal = chartInstance->c2_is_active_c2_MON_sl_after_harness;
  ...
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_harness = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(
       "is_active_c2_MON_sl_after_harness", c2_u, 8)),
     "is_active_c2_MON_sl_after_harness");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MON_sl_after_harness(chartInstance);
  ...
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_CMD_From_COM, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MON_sl_after_harness(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_MON_sl_after_harnessMachineNumber_,
  ...
  (SFc2_MON_sl_after_harnessInstanceStruct *chartInstance)
{
  ...
  c2_cond = c2_isequal(chartInstance, c2_mode_Agree_Nodes__Brake_Cmd_0, 2);
  c2_ifBranch = 170;
  c2_elseBranch = c2_ifFunction(chartInstance, c2_isequal(chartInstance,
    c2_mode_Agree_Nodes__Brake_Cmd_0, 3), 340, c2_ifFunction(chartInstance,
    c2_isequal(chartInstance, c2_mode_Agree_Nodes__Brake_Cmd_0, 4), 510,
    c2_pedal_Agree_Nodes__Brake_Cmd_0));
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c2_c_debug_family_names,
    c2_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_nargin, 0U, c2_h_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_nargout, 1U, c2_h_sf_marshallOut,
    c2_c_sf_marshallIn);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MON_sl_after_harnessInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_harnessInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_MON_sl_after_harness_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MON_sl_after_harness), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MON_sl_after_harness);
  return c2_y;
}
...
void sf_c2_MON_sl_after_harness_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3082226459U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2768645775U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3640519670U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3826698182U);
}

mxArray* sf_c2_MON_sl_after_harness_get_post_codegen_info(void);
mxArray *sf_c2_MON_sl_after_harness_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_MON_sl_after_harness_get_post_codegen_info();
...
mxArray *sf_c2_MON_sl_after_harness_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MON_sl_after_harness_jit_fallback_info(void)
{
...
mxArray *sf_c2_MON_sl_after_harness_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MON_sl_after_harnessInstanceStruct *chartInstance =
      (SFc2_MON_sl_after_harnessInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _MON_sl_after_harnessMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        init_script_number_translation(_MON_sl_after_harnessMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_MON_sl_after_harnessMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _MON_sl_after_harnessMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "sJPh899iu7e4qJor7dRCajH";
}

static void sf_opaque_initialize_c2_MON_sl_after_harness(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MON_sl_after_harness
    ((SFc2_MON_sl_after_harnessInstanceStruct*) chartInstanceVar);
  initialize_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_MON_sl_after_harness(void *chartInstanceVar)
{
  enable_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_MON_sl_after_harness(void *chartInstanceVar)
{
  disable_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_MON_sl_after_harness(void *chartInstanceVar)
{
  sf_gateway_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MON_sl_after_harness(SimStruct*
  S)
{
  return get_sim_state_c2_MON_sl_after_harness
    ((SFc2_MON_sl_after_harnessInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MON_sl_after_harness(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_MON_sl_after_harness(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MON_sl_after_harnessInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_MON_sl_after_harness((SFc2_MON_sl_after_harnessInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MON_sl_after_harness(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MON_sl_after_harness(SimStruct *S)
{
  /* Set overwritable ports for inplace optimization */
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_MON_sl_after_harness_optimization_info
  ...
  ssSetChecksum0(S,(3151544020U));
  ssSetChecksum1(S,(2885848342U));
  ssSetChecksum2(S,(1276863216U));
  ssSetChecksum3(S,(1249343881U));
...
static void mdlRTW_c2_MON_sl_after_harness(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MON_sl_after_harness(SimStruct *S)
{
  SFc2_MON_sl_after_harnessInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_harnessInstanceStruct *)utMalloc(sizeof
    (SFc2_MON_sl_after_harnessInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MON_sl_after_harnessInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MON_sl_after_harness;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MON_sl_after_harness;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MON_sl_after_harness;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_MON_sl_after_harness;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_MON_sl_after_harness;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MON_sl_after_harness;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MON_sl_after_harness;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MON_sl_after_harness;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MON_sl_after_harness;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MON_sl_after_harness;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MON_sl_after_harness;
  ...
  mdl_start_c2_MON_sl_after_harness(chartInstance);
}

void c2_MON_sl_after_harness_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MON_sl_after_harness(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MON_sl_after_harness(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MON_sl_after_harness(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MON_sl_after_harness_method_dispatcher.\n"
