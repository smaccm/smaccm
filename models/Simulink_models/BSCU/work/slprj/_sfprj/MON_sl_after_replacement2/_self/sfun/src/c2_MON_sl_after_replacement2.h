#ifndef __c2_MON_sl_after_replacement2_h__
#define __c2_MON_sl_after_replacement2_h__
...
#ifndef typedef_SFc2_MON_sl_after_replacement2InstanceStruct
#define typedef_SFc2_MON_sl_after_replacement2InstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_MON_sl_after_replacement2;
...
} SFc2_MON_sl_after_replacement2InstanceStruct;

#endif                                 /*typedef_SFc2_MON_sl_after_replacement2InstanceStruct*/
...
extern void sf_c2_MON_sl_after_replacement2_get_check_sum(mxArray *plhs[]);
extern void c2_MON_sl_after_replacement2_method_dispatcher(SimStruct *S, int_T
  method, void *data);
