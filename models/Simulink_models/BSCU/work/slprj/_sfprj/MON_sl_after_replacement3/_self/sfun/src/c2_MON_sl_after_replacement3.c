...
static void initialize_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void initialize_params_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void enable_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void disable_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void set_sim_state_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void sf_gateway_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void mdl_start_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void c2_chartstep_c2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
static void initSimStructsc2_MON_sl_after_replacement3
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_MON_sl_after_replacement3InstanceStruct
...
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_arrowFunction(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, boolean_T c2_b_first_time, boolean_T c2_left, boolean_T
  c2_right);
static boolean_T c2_isequal(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, int32_T c2_varargin_1, int32_T c2_varargin_2);
static int32_T c2_ifFunction(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, boolean_T c2_cond, int32_T c2_ifBranch, int32_T c2_elseBranch);
static int32_T c2_b_arrowFunction(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, boolean_T c2_b_first_time, int32_T c2_left, int32_T c2_right);
static boolean_T c2_b_ifFunction(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, boolean_T c2_cond, boolean_T c2_ifBranch, boolean_T
  c2_elseBranch);
static boolean_T c2_impliesFunction(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance, boolean_T c2_left, boolean_T c2_right);
static boolean_T c2_b_isequal(SFc2_MON_sl_after_replacement3InstanceStruct
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_MON_sl_after_replacement3, const char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MON_sl_after_replacement3InstanceStruct
  *chartInstance);
  ...
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MON_sl_after_replacement3(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_replacement3 = 0U;
}
  ...
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance)
{
  ...
  c2_i_hoistedGlobal = chartInstance->c2_is_active_c2_MON_sl_after_replacement3;
   ...
   *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_replacement3 =
    c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c2_MON_sl_after_replacement3", c2_u, 8)),
    "is_active_c2_MON_sl_after_replacement3");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MON_sl_after_replacement3(chartInstance);
  ...
  (SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_CMD_From_COM, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MON_sl_after_replacement3(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_replacement3InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_MON_sl_after_replacement3_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_MON_sl_after_replacement3, const char_T *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MON_sl_after_replacement3), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MON_sl_after_replacement3);
  return c2_y;
}
...
void sf_c2_MON_sl_after_replacement3_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_MON_sl_after_replacement3_get_post_codegen_info(void);
mxArray *sf_c2_MON_sl_after_replacement3_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_MON_sl_after_replacement3_get_post_codegen_info();
...
mxArray *sf_c2_MON_sl_after_replacement3_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MON_sl_after_replacement3_jit_fallback_info(void)
{
...
mxArray *sf_c2_MON_sl_after_replacement3_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance =
      (SFc2_MON_sl_after_replacement3InstanceStruct *)sf_get_chart_instance_ptr
      (S);
...
static void sf_opaque_initialize_c2_MON_sl_after_replacement3(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MON_sl_after_replacement3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
  initialize_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_MON_sl_after_replacement3(void *chartInstanceVar)
{
  enable_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_MON_sl_after_replacement3(void
  *chartInstanceVar)
{
  disable_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_MON_sl_after_replacement3(void
  *chartInstanceVar)
{
  sf_gateway_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MON_sl_after_replacement3
  (SimStruct* S)
{
  return get_sim_state_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MON_sl_after_replacement3(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c2_MON_sl_after_replacement3(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MON_sl_after_replacement3InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_MON_sl_after_replacement3
      ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_MON_sl_after_replacement3
    ((SFc2_MON_sl_after_replacement3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MON_sl_after_replacement3(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MON_sl_after_replacement3(SimStruct *S)
{
...
static void mdlRTW_c2_MON_sl_after_replacement3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MON_sl_after_replacement3(SimStruct *S)
{
  SFc2_MON_sl_after_replacement3InstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_replacement3InstanceStruct *)utMalloc
    (sizeof(SFc2_MON_sl_after_replacement3InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MON_sl_after_replacement3InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MON_sl_after_replacement3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MON_sl_after_replacement3;
  ...
  mdl_start_c2_MON_sl_after_replacement3(chartInstance);
}

void c2_MON_sl_after_replacement3_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MON_sl_after_replacement3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MON_sl_after_replacement3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MON_sl_after_replacement3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MON_sl_after_replacement3_method_dispatcher.\n"
