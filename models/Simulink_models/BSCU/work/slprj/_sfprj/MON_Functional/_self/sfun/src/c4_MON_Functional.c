...
static void initialize_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void initialize_params_c4_MON_Functional
  (SFc4_MON_FunctionalInstanceStruct *chartInstance);
static void enable_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void disable_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_MON_Functional
  (SFc4_MON_FunctionalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_MON_Functional
  (SFc4_MON_FunctionalInstanceStruct *chartInstance);
static void set_sim_state_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_MON_Functional
  (SFc4_MON_FunctionalInstanceStruct *chartInstance);
static void finalize_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void sf_gateway_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void mdl_start_c4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void initSimStructsc4_MON_Functional(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static int32_T c4_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static boolean_T c4_b_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_b_Active, const char_T *c4_identifier);
static boolean_T c4_c_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_MON_Functional, const char_T *
  c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *c4_f_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_b_setSimStateSideEffectsInfo, const char_T
  *c4_identifier);
static const mxArray *c4_g_emlrt_marshallIn(SFc4_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc4_MON_FunctionalInstanceStruct *chartInstance, int32_T c4_ssid);
static void c4_init_sf_message_store_memory(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_MON_FunctionalInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc4_MON_Functional(chartInstance);
  ...
  chartInstance->c4_is_active_c4_MON_Functional = 0U;
  ...
  (SFc4_MON_FunctionalInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_MON_Functional;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *chartInstance->c4_Active = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_MON_Functional = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c4_MON_Functional",
       c4_u, 1)), "is_active_c4_MON_Functional");
  ...
  c4_update_debugger_state_c4_MON_Functional(chartInstance);
  ...
  *chartInstance)
{
  ...
  c4_set_sim_state_side_effects_c4_MON_Functional(chartInstance);
...
const mxArray *sf_c4_MON_Functional_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_MON_FunctionalInstanceStruct *chartInstance;
  chartInstance = (SFc4_MON_FunctionalInstanceStruct *)chartInstanceVoid;
  ...
  c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_MON_Functional), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_MON_Functional);
  return c4_y;
}
...
void sf_c4_MON_Functional_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1979495232U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1972449438U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2710555940U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1874261593U);
}

mxArray* sf_c4_MON_Functional_get_post_codegen_info(void);
mxArray *sf_c4_MON_Functional_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_MON_Functional_get_post_codegen_info();
...
mxArray *sf_c4_MON_Functional_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_MON_Functional_jit_fallback_info(void)
{
...
mxArray *sf_c4_MON_Functional_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_MON_Functional(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"Active\",},{M[8],M[0],T\"is_active_c4_MON_Functional\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_MON_Functional_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc4_MON_FunctionalInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_MON_FunctionalInstanceStruct *chartInstance =
      (SFc4_MON_FunctionalInstanceStruct *)sf_get_chart_instance_ptr(S);
...
{
  return "sCTvb8FbuXJtSAmWe2QKtm";
}

static void sf_opaque_initialize_c4_MON_Functional(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
  initialize_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_MON_Functional(void *chartInstanceVar)
{
  enable_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_MON_Functional(void *chartInstanceVar)
{
  disable_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_MON_Functional(void *chartInstanceVar)
{
  sf_gateway_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_MON_Functional(SimStruct* S)
{
  return get_sim_state_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_MON_Functional(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c4_MON_Functional(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_MON_FunctionalInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MON_Functional_optimization_info();
    }

    finalize_c4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_MON_Functional((SFc4_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_MON_Functional(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_MON_Functional(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4292105829U));
  ssSetChecksum1(S,(4015969986U));
  ssSetChecksum2(S,(3693223707U));
  ssSetChecksum3(S,(3776422068U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_MON_Functional(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_MON_Functional(SimStruct *S)
{
  SFc4_MON_FunctionalInstanceStruct *chartInstance;
  chartInstance = (SFc4_MON_FunctionalInstanceStruct *)utMalloc(sizeof
    (SFc4_MON_FunctionalInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_MON_FunctionalInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_MON_Functional;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_MON_Functional;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_MON_Functional;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_MON_Functional;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_MON_Functional;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_MON_Functional;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_MON_Functional;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_MON_Functional;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_MON_Functional;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_MON_Functional;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_MON_Functional;
  ...
  mdl_start_c4_MON_Functional(chartInstance);
}

void c4_MON_Functional_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_MON_Functional(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_MON_Functional(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_MON_Functional(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_MON_Functional_method_dispatcher.\n"
