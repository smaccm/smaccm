...
static void initialize_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void initialize_params_c1_MON_Functional
  (SFc1_MON_FunctionalInstanceStruct *chartInstance);
static void enable_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void disable_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_MON_Functional
  (SFc1_MON_FunctionalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_MON_Functional
  (SFc1_MON_FunctionalInstanceStruct *chartInstance);
static void set_sim_state_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_MON_Functional
  (SFc1_MON_FunctionalInstanceStruct *chartInstance);
static void finalize_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void sf_gateway_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void mdl_start_c1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void initSimStructsc1_MON_Functional(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int32_T c1_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_b_sfEvent, const char_T *c1_identifier);
static int32_T c1_b_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_c_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_b_MANUAL, const char_T *c1_identifier);
static uint8_T c1_d_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_f_emlrt_marshallIn(SFc1_MON_FunctionalInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc1_MON_FunctionalInstanceStruct *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_MON_FunctionalInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_MON_Functional(chartInstance);
  ...
  chartInstance->c1_is_active_c1_MON_Functional = 0U;
  ...
  (SFc1_MON_FunctionalInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_MON_Functional;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_r = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_MON_Functional = c1_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c1_MON_Functional",
       c1_u, 1)), "is_active_c1_MON_Functional");
  ...
  c1_update_debugger_state_c1_MON_Functional(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_MON_Functional(chartInstance);
...
const mxArray *sf_c1_MON_Functional_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_MON_FunctionalInstanceStruct *chartInstance;
  chartInstance = (SFc1_MON_FunctionalInstanceStruct *)chartInstanceVoid;
...
void sf_c1_MON_Functional_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(824740031U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3875818932U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2025421848U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(401941183U);
}

mxArray* sf_c1_MON_Functional_get_post_codegen_info(void);
mxArray *sf_c1_MON_Functional_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_MON_Functional_get_post_codegen_info();
...
mxArray *sf_c1_MON_Functional_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_MON_Functional_jit_fallback_info(void)
{
...
mxArray *sf_c1_MON_Functional_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_MON_Functional(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"r\",},{M[8],M[0],T\"is_active_c1_MON_Functional\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_MON_Functional_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_MON_FunctionalInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_MON_FunctionalInstanceStruct *chartInstance =
      (SFc1_MON_FunctionalInstanceStruct *)sf_get_chart_instance_ptr(S);
...
{
  return "s7ocolEgUeBxh20iYZ4GzaB";
}

static void sf_opaque_initialize_c1_MON_Functional(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
  initialize_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_MON_Functional(void *chartInstanceVar)
{
  enable_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_MON_Functional(void *chartInstanceVar)
{
  disable_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_MON_Functional(void *chartInstanceVar)
{
  sf_gateway_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_MON_Functional(SimStruct* S)
{
  return get_sim_state_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_MON_Functional(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_MON_Functional(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_MON_FunctionalInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MON_Functional_optimization_info();
    }

    finalize_c1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_MON_Functional((SFc1_MON_FunctionalInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_MON_Functional(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_MON_Functional(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1579614738U));
  ssSetChecksum1(S,(32913524U));
  ssSetChecksum2(S,(4282014648U));
  ssSetChecksum3(S,(1766036300U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_MON_Functional(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_MON_Functional(SimStruct *S)
{
  SFc1_MON_FunctionalInstanceStruct *chartInstance;
  chartInstance = (SFc1_MON_FunctionalInstanceStruct *)utMalloc(sizeof
    (SFc1_MON_FunctionalInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_MON_FunctionalInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_MON_Functional;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_MON_Functional;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_MON_Functional;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_MON_Functional;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_MON_Functional;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_MON_Functional;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_MON_Functional;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_MON_Functional;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_MON_Functional;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_MON_Functional;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_MON_Functional;
  ...
  mdl_start_c1_MON_Functional(chartInstance);
}

void c1_MON_Functional_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_MON_Functional(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_MON_Functional(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_MON_Functional(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_MON_Functional_method_dispatcher.\n"
