...
static void initialize_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void initialize_params_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void enable_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void disable_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void set_sim_state_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance, const mxArray
   *c3_st);
static void c3_set_sim_state_side_effects_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void finalize_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void sf_gateway_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void mdl_start_c3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void initSimStructsc3_MON_sl_after_replacement1
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_MON_sl_after_replacement1InstanceStruct *
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance, int32_T c3_ssid);
static void c3_init_sf_message_store_memory
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance);
static void init_dsm_address_info(SFc3_MON_sl_after_replacement1InstanceStruct
  *chartInstance);
  ...
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc3_MON_sl_after_replacement1(chartInstance);
  ...
  chartInstance->c3_is_active_c3_MON_sl_after_replacement1 = 0U;
  ...
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_MON_sl_after_replacement1;
   ...
   *c3_st)
{
  ...
  *chartInstance->c3_r = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_MON_sl_after_replacement1 =
    c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c3_MON_sl_after_replacement1", c3_u, 1)),
    "is_active_c3_MON_sl_after_replacement1");
  ...
  c3_update_debugger_state_c3_MON_sl_after_replacement1(chartInstance);
  ...
  (SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_MON_sl_after_replacement1(chartInstance);
...
const mxArray *sf_c3_MON_sl_after_replacement1_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance;
  chartInstance = (SFc3_MON_sl_after_replacement1InstanceStruct *)
    chartInstanceVoid;
...
void sf_c3_MON_sl_after_replacement1_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_MON_sl_after_replacement1_get_post_codegen_info(void);
mxArray *sf_c3_MON_sl_after_replacement1_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_MON_sl_after_replacement1_get_post_codegen_info();
...
mxArray *sf_c3_MON_sl_after_replacement1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_MON_sl_after_replacement1_jit_fallback_info(void)
{
...
mxArray *sf_c3_MON_sl_after_replacement1_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_MON_sl_after_replacement1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"r\",},{M[8],M[0],T\"is_active_c3_MON_sl_after_replacement1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_MON_sl_after_replacement1_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc3_MON_sl_after_replacement1InstanceStruct *) chartInstance, msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance =
      (SFc3_MON_sl_after_replacement1InstanceStruct *)sf_get_chart_instance_ptr
      (S);
...
static void sf_opaque_initialize_c3_MON_sl_after_replacement1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_MON_sl_after_replacement1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
  initialize_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_MON_sl_after_replacement1(void *chartInstanceVar)
{
  enable_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_MON_sl_after_replacement1(void
  *chartInstanceVar)
{
  disable_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_MON_sl_after_replacement1(void
  *chartInstanceVar)
{
  sf_gateway_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_MON_sl_after_replacement1
  (SimStruct* S)
{
  return get_sim_state_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_MON_sl_after_replacement1(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c3_MON_sl_after_replacement1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_MON_sl_after_replacement1InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_MON_sl_after_replacement1
      ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_MON_sl_after_replacement1
    ((SFc3_MON_sl_after_replacement1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_MON_sl_after_replacement1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_MON_sl_after_replacement1(SimStruct *S)
{
...
static void mdlRTW_c3_MON_sl_after_replacement1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_MON_sl_after_replacement1(SimStruct *S)
{
  SFc3_MON_sl_after_replacement1InstanceStruct *chartInstance;
  chartInstance = (SFc3_MON_sl_after_replacement1InstanceStruct *)utMalloc
    (sizeof(SFc3_MON_sl_after_replacement1InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc3_MON_sl_after_replacement1InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_MON_sl_after_replacement1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_MON_sl_after_replacement1;
  ...
  mdl_start_c3_MON_sl_after_replacement1(chartInstance);
}

void c3_MON_sl_after_replacement1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_MON_sl_after_replacement1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_MON_sl_after_replacement1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_MON_sl_after_replacement1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_MON_sl_after_replacement1_method_dispatcher.\n"
