...
#include "c2_MON_sl_replacement.h"
...
static void initialize_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void initialize_params_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void enable_c2_MON_sl_replacement(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance);
static void disable_c2_MON_sl_replacement(SFc2_MON_sl_replacementInstanceStruct *
  chartInstance);
static void c2_update_debugger_state_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void set_sim_state_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_MON_sl_replacement(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance);
static void sf_gateway_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void mdl_start_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void c2_chartstep_c2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void initSimStructsc2_MON_sl_replacement
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static boolean_T c2_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_b_pre_r_Agree_Nodes__Latch_0, const char_T
  *c2_identifier, boolean_T *c2_svPtr);
static boolean_T c2_b_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_b_pre_mode_Agree_Nodes__Brake_Mode_0, const
  char_T *c2_identifier, boolean_T *c2_svPtr);
static int32_T c2_d_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T *c2_svPtr);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_f_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static int32_T c2_g_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_arrowFunction(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, boolean_T c2_left, boolean_T
  c2_right);
static boolean_T c2_isequal(SFc2_MON_sl_replacementInstanceStruct *chartInstance,
  int32_T c2_varargin_1, int32_T c2_varargin_2);
static int32_T c2_ifFunction(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, boolean_T c2_cond, int32_T c2_ifBranch, int32_T c2_elseBranch);
static int32_T c2_b_arrowFunction(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, int32_T c2_left, int32_T c2_right);
static boolean_T c2_b_ifFunction(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, boolean_T c2_cond, boolean_T c2_ifBranch, boolean_T
  c2_elseBranch);
static boolean_T c2_impliesFunction(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, boolean_T c2_left, boolean_T c2_right);
static boolean_T c2_b_isequal(SFc2_MON_sl_replacementInstanceStruct
...
static uint8_T c2_h_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MON_sl_replacement, const
  char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_MON_sl_replacementInstanceStruct
  *chartInstance);
  ...
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MON_sl_replacement(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MON_sl_replacement = 0U;
}
  ...
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance)
{
  ...
  c2_i_hoistedGlobal = chartInstance->c2_is_active_c2_MON_sl_replacement;
  ...
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_MON_sl_replacement = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c2_MON_sl_replacement",
       c2_u, 8)), "is_active_c2_MON_sl_replacement");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MON_sl_replacement(chartInstance);
  ...
  (SFc2_MON_sl_replacementInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_CMD_From_COM, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MON_sl_replacement(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MON_sl_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_replacementInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_MON_sl_replacement_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MON_sl_replacement), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MON_sl_replacement);
  return c2_y;
}
...
void sf_c2_MON_sl_replacement_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_MON_sl_replacement_get_post_codegen_info(void);
mxArray *sf_c2_MON_sl_replacement_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_MON_sl_replacement_get_post_codegen_info();
...
mxArray *sf_c2_MON_sl_replacement_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MON_sl_replacement_jit_fallback_info(void)
{
...
mxArray *sf_c2_MON_sl_replacement_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MON_sl_replacementInstanceStruct *chartInstance =
      (SFc2_MON_sl_replacementInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c2_MON_sl_replacement(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
  initialize_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_MON_sl_replacement(void *chartInstanceVar)
{
  enable_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_MON_sl_replacement(void *chartInstanceVar)
{
  disable_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_MON_sl_replacement(void *chartInstanceVar)
{
  sf_gateway_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MON_sl_replacement(SimStruct* S)
{
  return get_sim_state_c2_MON_sl_replacement
    ((SFc2_MON_sl_replacementInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MON_sl_replacement(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_MON_sl_replacement(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MON_sl_replacementInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_MON_sl_replacement((SFc2_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MON_sl_replacement(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_MON_sl_replacement
      ((SFc2_MON_sl_replacementInstanceStruct*)sf_get_chart_instance_ptr(S));
  }
}

static void mdlSetWorkWidths_c2_MON_sl_replacement(SimStruct *S)
{
...
static void mdlRTW_c2_MON_sl_replacement(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MON_sl_replacement(SimStruct *S)
{
  SFc2_MON_sl_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_replacementInstanceStruct *)utMalloc(sizeof
    (SFc2_MON_sl_replacementInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MON_sl_replacementInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MON_sl_replacement;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MON_sl_replacement;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MON_sl_replacement;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_MON_sl_replacement;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_MON_sl_replacement;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MON_sl_replacement;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MON_sl_replacement;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MON_sl_replacement;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MON_sl_replacement;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MON_sl_replacement;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MON_sl_replacement;
  ...
  mdl_start_c2_MON_sl_replacement(chartInstance);
}

void c2_MON_sl_replacement_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MON_sl_replacement(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MON_sl_replacement(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MON_sl_replacement(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MON_sl_replacement_method_dispatcher.\n"
