...
#include "c4_MON_sl_replacement.h"
...
static void initialize_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void initialize_params_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void enable_c4_MON_sl_replacement(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance);
static void disable_c4_MON_sl_replacement(SFc4_MON_sl_replacementInstanceStruct *
  chartInstance);
static void c4_update_debugger_state_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void set_sim_state_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance, const mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void finalize_c4_MON_sl_replacement(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance);
static void sf_gateway_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void mdl_start_c4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void initSimStructsc4_MON_sl_replacement
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static int32_T c4_emlrt_marshallIn(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static boolean_T c4_b_emlrt_marshallIn(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c4_b_Active, const char_T *c4_identifier);
static boolean_T c4_c_emlrt_marshallIn(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_MON_sl_replacement, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *c4_f_emlrt_marshallIn
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance, const mxArray
   *c4_b_setSimStateSideEffectsInfo, const char_T *c4_identifier);
static const mxArray *c4_g_emlrt_marshallIn
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance, const mxArray *c4_u,
   const emlrtMsgIdentifier *c4_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance, int32_T c4_ssid);
static void c4_init_sf_message_store_memory
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_MON_sl_replacementInstanceStruct
  *chartInstance);
  ...
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc4_MON_sl_replacement(chartInstance);
  ...
  chartInstance->c4_is_active_c4_MON_sl_replacement = 0U;
  ...
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_MON_sl_replacement;
  ...
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *chartInstance->c4_Active = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_MON_sl_replacement = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c4_MON_sl_replacement",
       c4_u, 1)), "is_active_c4_MON_sl_replacement");
  ...
  c4_update_debugger_state_c4_MON_sl_replacement(chartInstance);
  ...
  (SFc4_MON_sl_replacementInstanceStruct *chartInstance)
{
  ...
  c4_set_sim_state_side_effects_c4_MON_sl_replacement(chartInstance);
...
const mxArray *sf_c4_MON_sl_replacement_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_MON_sl_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc4_MON_sl_replacementInstanceStruct *)chartInstanceVoid;
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_MON_sl_replacement), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_MON_sl_replacement);
  return c4_y;
}
...
void sf_c4_MON_sl_replacement_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_MON_sl_replacement_get_post_codegen_info(void);
mxArray *sf_c4_MON_sl_replacement_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_MON_sl_replacement_get_post_codegen_info();
...
mxArray *sf_c4_MON_sl_replacement_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_MON_sl_replacement_jit_fallback_info(void)
{
...
mxArray *sf_c4_MON_sl_replacement_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_MON_sl_replacement(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"Active\",},{M[8],M[0],T\"is_active_c4_MON_sl_replacement\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_MON_sl_replacement_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc4_MON_sl_replacementInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_MON_sl_replacementInstanceStruct *chartInstance =
      (SFc4_MON_sl_replacementInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c4_MON_sl_replacement(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
  initialize_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_MON_sl_replacement(void *chartInstanceVar)
{
  enable_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_MON_sl_replacement(void *chartInstanceVar)
{
  disable_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_MON_sl_replacement(void *chartInstanceVar)
{
  sf_gateway_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_MON_sl_replacement(SimStruct* S)
{
  return get_sim_state_c4_MON_sl_replacement
    ((SFc4_MON_sl_replacementInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_MON_sl_replacement(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c4_MON_sl_replacement(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_MON_sl_replacementInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_MON_sl_replacement((SFc4_MON_sl_replacementInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_MON_sl_replacement(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_MON_sl_replacement
      ((SFc4_MON_sl_replacementInstanceStruct*)sf_get_chart_instance_ptr(S));
  }
}

static void mdlSetWorkWidths_c4_MON_sl_replacement(SimStruct *S)
{
...
static void mdlRTW_c4_MON_sl_replacement(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_MON_sl_replacement(SimStruct *S)
{
  SFc4_MON_sl_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc4_MON_sl_replacementInstanceStruct *)utMalloc(sizeof
    (SFc4_MON_sl_replacementInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_MON_sl_replacementInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_MON_sl_replacement;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_MON_sl_replacement;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_MON_sl_replacement;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_MON_sl_replacement;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_MON_sl_replacement;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_MON_sl_replacement;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_MON_sl_replacement;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_MON_sl_replacement;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_MON_sl_replacement;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_MON_sl_replacement;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_MON_sl_replacement;
  ...
  mdl_start_c4_MON_sl_replacement(chartInstance);
}

void c4_MON_sl_replacement_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_MON_sl_replacement(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_MON_sl_replacement(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_MON_sl_replacement(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_MON_sl_replacement_method_dispatcher.\n"
