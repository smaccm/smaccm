...
static void initialize_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initialize_params_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void enable_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void disable_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void set_sim_state_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void sf_gateway_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void mdl_start_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void c2_chartstep_c2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initSimStructsc2_MON_sl_after_replacement
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static boolean_T c2_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c2_b_pre_mode_Agree_Nodes__Brake_Mode_0, const
  char_T *c2_identifier, boolean_T *c2_svPtr);
static int32_T c2_d_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static int32_T c2_g_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static boolean_T c2_arrowFunction(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, boolean_T c2_left, boolean_T
  c2_right);
static boolean_T c2_isequal(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, int32_T c2_varargin_1, int32_T c2_varargin_2);
static int32_T c2_ifFunction(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, boolean_T c2_cond, int32_T c2_ifBranch, int32_T c2_elseBranch);
static int32_T c2_b_arrowFunction(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, boolean_T c2_b_first_time, int32_T c2_left, int32_T c2_right);
static boolean_T c2_b_ifFunction(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, boolean_T c2_cond, boolean_T c2_ifBranch, boolean_T
  c2_elseBranch);
static boolean_T c2_impliesFunction(SFc2_MON_sl_after_replacementInstanceStruct *
  chartInstance, boolean_T c2_left, boolean_T c2_right);
static boolean_T c2_b_isequal(SFc2_MON_sl_after_replacementInstanceStruct
...
static uint8_T c2_h_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MON_sl_after_replacement,
  const char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_MON_sl_after_replacementInstanceStruct
  *chartInstance);
  ...
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MON_sl_after_replacement(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_replacement = 0U;
}
  ...
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  c2_i_hoistedGlobal = chartInstance->c2_is_active_c2_MON_sl_after_replacement;
   ...
   *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_MON_sl_after_replacement =
    c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c2_MON_sl_after_replacement", c2_u, 8)),
    "is_active_c2_MON_sl_after_replacement");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MON_sl_after_replacement(chartInstance);
  ...
  (SFc2_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_CMD_From_COM, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MON_sl_after_replacement(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_MON_sl_after_replacementMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_replacementInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_MON_sl_after_replacement_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MON_sl_after_replacement), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MON_sl_after_replacement);
  return c2_y;
}
...
void sf_c2_MON_sl_after_replacement_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(93257563U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(228665276U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(614762467U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2051066029U);
}

mxArray* sf_c2_MON_sl_after_replacement_get_post_codegen_info(void);
mxArray *sf_c2_MON_sl_after_replacement_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("SFS5TcV6VqkK7ok3hnpdHF");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_MON_sl_after_replacement_get_post_codegen_info();
...
mxArray *sf_c2_MON_sl_after_replacement_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MON_sl_after_replacement_jit_fallback_info(void)
{
...
mxArray *sf_c2_MON_sl_after_replacement_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MON_sl_after_replacementInstanceStruct *chartInstance =
      (SFc2_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _MON_sl_after_replacementMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        init_script_number_translation(_MON_sl_after_replacementMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_MON_sl_after_replacementMachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,5532);
        _SFD_CV_INIT_EML_FCN(0,1,"ifFunction",5534,-1,5655);
        _SFD_CV_INIT_EML_FCN(0,2,"arrowFunction",5657,-1,5775);
        _SFD_CV_INIT_EML_FCN(0,3,"impliesFunction",5777,-1,5859);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,0,"cvmetric_Sldv_proof",5361,-1,5383);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,1,"cvmetric_Sldv_proof",5385,-1,5407);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,2,"cvmetric_Sldv_proof",5409,-1,5431);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,3,"cvmetric_Sldv_proof",5433,-1,5455);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,4,"cvmetric_Sldv_proof",5457,-1,5479);
        _SFD_CV_INIT_EML_TESTOBJECTIVE(0,1,5,"cvmetric_Sldv_proof",5481,-1,5527);
        ...
        _SFD_CV_INIT_EML_IF(0,1,8,5591,5600,5621,5651);
        _SFD_CV_INIT_EML_IF(0,1,9,5714,5729,5746,5771);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _MON_sl_after_replacementMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "sBhnVW9RQaTI3mttsnAEnPB";
}

static void sf_opaque_initialize_c2_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MON_sl_after_replacementInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
  initialize_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_MON_sl_after_replacement(void *chartInstanceVar)
{
  enable_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_MON_sl_after_replacement(void *chartInstanceVar)
{
  disable_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_MON_sl_after_replacement(void *chartInstanceVar)
{
  sf_gateway_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MON_sl_after_replacement
  (SimStruct* S)
{
  return get_sim_state_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MON_sl_after_replacement(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c2_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MON_sl_after_replacementInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_MON_sl_after_replacement
      ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_MON_sl_after_replacement
    ((SFc2_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MON_sl_after_replacement(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MON_sl_after_replacement(SimStruct *S)
{
  /* Set overwritable ports for inplace optimization */
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_MON_sl_after_replacement_optimization_info
  ...
  ssSetChecksum0(S,(213374303U));
  ssSetChecksum1(S,(1863690933U));
  ssSetChecksum2(S,(1562605679U));
  ssSetChecksum3(S,(317464000U));
...
static void mdlRTW_c2_MON_sl_after_replacement(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MON_sl_after_replacement(SimStruct *S)
{
  SFc2_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc2_MON_sl_after_replacementInstanceStruct *)utMalloc(sizeof
    (SFc2_MON_sl_after_replacementInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MON_sl_after_replacementInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MON_sl_after_replacement;
  ...
  mdl_start_c2_MON_sl_after_replacement(chartInstance);
}

void c2_MON_sl_after_replacement_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MON_sl_after_replacement(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MON_sl_after_replacement_method_dispatcher.\n"
