...
static void initialize_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initialize_params_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void enable_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void disable_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void set_sim_state_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void c1_set_sim_state_side_effects_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void finalize_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void sf_gateway_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void mdl_start_c1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initSimStructsc1_MON_sl_after_replacement
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int32_T c1_emlrt_marshallIn(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c1_b_sfEvent, const char_T *c1_identifier);
static int32_T c1_b_emlrt_marshallIn(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_c_emlrt_marshallIn(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c1_b_MANUAL, const char_T *c1_identifier);
static uint8_T c1_d_emlrt_marshallIn(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_MON_sl_after_replacementInstanceStruct
  *chartInstance);
  ...
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_MON_sl_after_replacement(chartInstance);
  ...
  chartInstance->c1_is_active_c1_MON_sl_after_replacement = 0U;
  ...
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_MON_sl_after_replacement;
   ...
   *c1_st)
{
  ...
  *chartInstance->c1_r = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_MON_sl_after_replacement =
    c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c1_MON_sl_after_replacement", c1_u, 1)),
    "is_active_c1_MON_sl_after_replacement");
  ...
  c1_update_debugger_state_c1_MON_sl_after_replacement(chartInstance);
  ...
  (SFc1_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_MON_sl_after_replacement(chartInstance);
...
const mxArray *sf_c1_MON_sl_after_replacement_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc1_MON_sl_after_replacementInstanceStruct *)
    chartInstanceVoid;
...
void sf_c1_MON_sl_after_replacement_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_MON_sl_after_replacement_get_post_codegen_info(void);
mxArray *sf_c1_MON_sl_after_replacement_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c1_MON_sl_after_replacement_get_post_codegen_info();
...
mxArray *sf_c1_MON_sl_after_replacement_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_MON_sl_after_replacement_jit_fallback_info(void)
{
...
mxArray *sf_c1_MON_sl_after_replacement_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_MON_sl_after_replacement(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"r\",},{M[8],M[0],T\"is_active_c1_MON_sl_after_replacement\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_MON_sl_after_replacement_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_MON_sl_after_replacementInstanceStruct
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_MON_sl_after_replacementInstanceStruct *chartInstance =
      (SFc1_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c1_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_MON_sl_after_replacementInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
  initialize_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_MON_sl_after_replacement(void *chartInstanceVar)
{
  enable_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_MON_sl_after_replacement(void *chartInstanceVar)
{
  disable_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_MON_sl_after_replacement(void *chartInstanceVar)
{
  sf_gateway_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_MON_sl_after_replacement
  (SimStruct* S)
{
  return get_sim_state_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_MON_sl_after_replacement(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c1_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_MON_sl_after_replacementInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c1_MON_sl_after_replacement
      ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_MON_sl_after_replacement
    ((SFc1_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_MON_sl_after_replacement(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_MON_sl_after_replacement(SimStruct *S)
{
...
static void mdlRTW_c1_MON_sl_after_replacement(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_MON_sl_after_replacement(SimStruct *S)
{
  SFc1_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc1_MON_sl_after_replacementInstanceStruct *)utMalloc(sizeof
    (SFc1_MON_sl_after_replacementInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_MON_sl_after_replacementInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_MON_sl_after_replacement;
  ...
  mdl_start_c1_MON_sl_after_replacement(chartInstance);
}

void c1_MON_sl_after_replacement_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_MON_sl_after_replacement(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_MON_sl_after_replacement_method_dispatcher.\n"
