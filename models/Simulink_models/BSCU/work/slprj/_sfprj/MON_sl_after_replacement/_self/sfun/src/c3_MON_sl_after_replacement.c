...
static void initialize_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initialize_params_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void enable_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void disable_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void set_sim_state_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void c3_set_sim_state_side_effects_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void finalize_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void sf_gateway_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void mdl_start_c3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void initSimStructsc3_MON_sl_after_replacement
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c3_b_sfEvent, const char_T *c3_identifier);
static int32_T c3_b_emlrt_marshallIn(SFc3_MON_sl_after_replacementInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_c_emlrt_marshallIn(SFc3_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c3_b_MANUAL, const char_T *c3_identifier);
static uint8_T c3_d_emlrt_marshallIn(SFc3_MON_sl_after_replacementInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance, int32_T c3_ssid);
static void c3_init_sf_message_store_memory
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc3_MON_sl_after_replacementInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_MON_sl_after_replacementInstanceStruct
  *chartInstance);
  ...
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc3_MON_sl_after_replacement(chartInstance);
  ...
  chartInstance->c3_is_active_c3_MON_sl_after_replacement = 0U;
  ...
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_MON_sl_after_replacement;
   ...
   *c3_st)
{
  ...
  *chartInstance->c3_r = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_MON_sl_after_replacement =
    c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c3_MON_sl_after_replacement", c3_u, 1)),
    "is_active_c3_MON_sl_after_replacement");
  ...
  c3_update_debugger_state_c3_MON_sl_after_replacement(chartInstance);
  ...
  (SFc3_MON_sl_after_replacementInstanceStruct *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_MON_sl_after_replacement(chartInstance);
...
const mxArray *sf_c3_MON_sl_after_replacement_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc3_MON_sl_after_replacementInstanceStruct *)
    chartInstanceVoid;
...
void sf_c3_MON_sl_after_replacement_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_MON_sl_after_replacement_get_post_codegen_info(void);
mxArray *sf_c3_MON_sl_after_replacement_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_MON_sl_after_replacement_get_post_codegen_info();
...
mxArray *sf_c3_MON_sl_after_replacement_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_MON_sl_after_replacement_jit_fallback_info(void)
{
...
mxArray *sf_c3_MON_sl_after_replacement_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_MON_sl_after_replacement(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[1780],T\"r\",},{M[8],M[0],T\"is_active_c3_MON_sl_after_replacement\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_MON_sl_after_replacement_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc3_MON_sl_after_replacementInstanceStruct
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_MON_sl_after_replacementInstanceStruct *chartInstance =
      (SFc3_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c3_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_MON_sl_after_replacementInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
  initialize_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_MON_sl_after_replacement(void *chartInstanceVar)
{
  enable_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_MON_sl_after_replacement(void *chartInstanceVar)
{
  disable_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_MON_sl_after_replacement(void *chartInstanceVar)
{
  sf_gateway_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_MON_sl_after_replacement
  (SimStruct* S)
{
  return get_sim_state_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_MON_sl_after_replacement(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c3_MON_sl_after_replacement(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_MON_sl_after_replacementInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_MON_sl_after_replacement
      ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_MON_sl_after_replacement
    ((SFc3_MON_sl_after_replacementInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_MON_sl_after_replacement(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_MON_sl_after_replacement(SimStruct *S)
{
...
static void mdlRTW_c3_MON_sl_after_replacement(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_MON_sl_after_replacement(SimStruct *S)
{
  SFc3_MON_sl_after_replacementInstanceStruct *chartInstance;
  chartInstance = (SFc3_MON_sl_after_replacementInstanceStruct *)utMalloc(sizeof
    (SFc3_MON_sl_after_replacementInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc3_MON_sl_after_replacementInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_MON_sl_after_replacement;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_MON_sl_after_replacement;
  ...
  mdl_start_c3_MON_sl_after_replacement(chartInstance);
}

void c3_MON_sl_after_replacement_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_MON_sl_after_replacement(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_MON_sl_after_replacement(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_MON_sl_after_replacement_method_dispatcher.\n"
