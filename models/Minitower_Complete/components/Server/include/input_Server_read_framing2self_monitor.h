 ...
 */
#ifndef __INPUT_SERVER_READ_FRAMING2SELF_MONITOR_H__
#define __INPUT_SERVER_READ_FRAMING2SELF_MONITOR_H__
#ifdef __cplusplus
extern "C" {
#endif
...
void callback_input_Server_read_framing2self_handler(const uint8_t n_var0[80U]);

#ifdef __cplusplus
}
#endif
#endif /* __INPUT_SERVER_READ_FRAMING2SELF_MONITOR_H__ */